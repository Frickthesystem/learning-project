 ...
 * [awesome-chatgpt-project](https://github.com/xianyu110/awesome-chatgpt-project) - 1. chatGPT registration2. chatGPT finished project organization3. Tips for efficient use of chatGPT4. Training guide â Demo website
 ...
 * [awesome-chatgpt-zh](https://github.com/embraceagi/awesome-chatgpt-zh) - ChatGPT Chinese Guideð¥, ChatGPT Chinese Training Guide, Instruction Guide, Application Development Guide, curated resource list, use ChatGPT better to boost your productivity up up up! ð
 ...
 * [wonderful-prompts](https://github.com/yzfly/wonderful-prompts) - ð¥Selected Chinese promptsð¥, ChatGPT User Guide, Enhance ChatGPT's Playability and Usability!ð
 ...
 * [wonderful-prompts](https://github.com/langgptai/wonderful-prompts) - ð¥Selected Chinese promptð¥, ChatGPT user guide, enhancing the playability and usability of ChatGPT!ð
 ...
 * [helicone](https://github.com/helicone/helicone) - ð§ Open source LLM-Observability Platform for Developers. One-line integration for monitoring, metrics, evals, agent tracing, prompt management, playground, etc. Supports OpenAI SDK, Vercel AI SDK, Anthropic SDK, LiteLLM, LLamaIndex, LangChain, and more. ð
 ...
 * [wukong-robot](https://github.com/wzpan/wukong-robot) - ð¤ Wukong-robot is a simple, flexible, and elegant Chinese voice conversation robot/smart speaker project that supports ChatGPT's multi-turn conversation capability. It may also be the first open-source smart speaker project that supports brain-computer interaction.
 ...
 * [AstrBot](https://github.com/soulter/astrbot) - â­ ChatGPT, Bing, Claude, and HuggingChat are all available robots that can be used on QQ and QQ Channel. They support plugins. | Formerly known as QQChannelChatGPT.
 * [casibase](https://github.com/casibase/casibase) - â¡ï¸Open-source LangChain-like AI knowledge database with web UI,and Enterprise SSOâ¡ï¸, supports OpenAI, Azure, HuggingFace, OpenRouter, ChatGLM and local models, chat demo: https://ai.casbin.com, admin portal demo: https://ai.casibase.com
 ...
 * [wechat-bot](https://github.com/wangrongding/wechat-bot) - ð¤A WeChat robot based on OpenAI ChatGPT and WeChaty, which can be used to help you automatically reply to WeChat messages, or manage WeChat groups/friends, detect zombie fans, etc.
 ...
 * [sagittarius](https://github.com/gregsadetsky/sagittarius) - Un outil d'exploration vocale/vidÃ©o GPT-4/Gemini.
 ...
 * [Streamer-Sales](https://github.com/peterh0323/streamer-sales) - Streamer-Sales éå  ââ åè´§ä¸»æ­ LLM å¤§æ¨¡åðð, a sales anchor model that can describe products based on their characteristics and inspire users to make purchases. ðâ­ It includes a detailed data generation process. â ð¦ It also integrates LMDeploy for accelerated reasoning ð, RAG retrieval enhanced generation ð, and TTS text-to-speech conversion ð.
 ...
 * [XYBot](https://github.com/henryxiaoyang/xybot) - WeChat robot based on docker and pywxdll hook injection! â Highly customizable! â Supports self-written plugins! Many functions: weather ð¤ï¸, get news ð°, ChatGPT chat ð£ï¸, Hypixel player query ð®, random pictures ð·, random links ð, random group members ð¥, Gomoku âï¸, check-in â, check points ð, points leaderboard ð, points transfer ð°, points lottery ð, points red envelope ð§§, etc.
 ...
 * [CreativeChatGLM](https://github.com/ypwhs/creativechatglm) - ð Welcome to ChatGLM Creative World! You can use the revision and continuation functions to generate creative content!
 ...
 * [Starmoon](https://github.com/starmoonai/starmoon) - An open source voice-enabled, compact, empathic AI hardware + software ð¤ framework for companionship, entertainment, education, pediatric care, IoT robotics applications, AI-enhanced robotics application services, research, and DIY robotics kit development
 ...
 * [kirara-ai](https://github.com/lss233/kirara-ai) - ð¤ DIY multimodal AI chatbot | ð Quickly integrate WeChat, QQ, Telegram, and other chat platforms | ð¦ Supports DeepSeek, Grok, Claude, Ollama, Gemini, OpenAI | Workflow system, web search, AI drawing, character training, virtual maid, voice conversation |
 ...
 * [AstrBot](https://github.com/astrbotdevs/astrbot) - â¨ Easy-to-use multi-platform LLM chatbot and development framework â¨ Platform supports QQ, QQ channel, Telegram, WeChat, Enterprise WeChat, Feishu | MCP server, OpenAI, DeepSeek, Gemini, Silicon Mobility, Dark Side of the Moon, Ollama, OneAPI, Dify, etc. With WebUI attached.
 ...
 * [llmcord](https://github.com/jakobdylanc/llmcord) - Make Discord your LLM frontend â Supports any OpenAI compatible API (Ollama, LM Studio, vLLM, OpenRouter, xAI, Mistral, Groq and more)
 * [flock](https://github.com/onelevenvy/flock) - Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.ï¼Flock æ¯ä¸ä¸ªåºäºworkflowå·¥ä½æµçä½ä»£ç å¹³å°ï¼ç¨äºå¿«éæå»ºèå¤©æºå¨äººãRAGãAgentåMuti-Agentåºç¨ï¼éç¨ LangGraphãLangchain
 ...
 * [XYBotV2](https://github.com/henryxiaoyang/xybotv2) - ð¤ Feature-rich WeChat robot framework | AI dialogue, integration with Dify, points system, game interaction, daily news, weather query | Non-Hook non-Web implementation | Supports Windowsâ Linuxâ MacOSâ | New architecture solves the pain points of the first generation XYBot!
 ...
 * [ReadSomething](https://github.com/readsomething/readsomething) - ð An open-source Chrome extension that can convert web pages into a reading mode, and also includes built-in AI summarization, translation, Markdown conversion, and other functions.
 ...
 * [crawlee-python](https://github.com/apify/crawlee-python) - CrawleeâA web scraping and browser automation library for Python to build reliable crawlers. Extract data for AI, LLMs, RAG, or GPTs. Download HTML, PDF, JPG, PNG, and other files from websites. Works with BeautifulSoup, Playwright, and raw HTTP. Both head
 ...
 * [solon](https://github.com/opensolon/solon) - ð¥ Java enterprise application development framework for full scenario: Restrained, Efficient, Open, Ecologicalll!!! 700% higher concurrency 50% memory savings Startup is 10 times faster. Packing 90% smaller; Compatible with java8 ~ java24. (Replaceable spr
 ...
 * [ChatGPT](https://github.com/acheong08/chatgpt) - ChatGPT API reverse engineered.
 ...
 * [DirectAI](https://github.com/ustayready/directai) - Ask ChatGPT questions using the OpenAI API in your terminal.
 ...
 * [opencommit](https://github.com/di-sukharev/opencommit) - Use GPT CLI to automatically generate impressive commits in just one second. Mind-blowing! ð¥
 ...
 * [gptel](https://github.com/karthink/gptel) - Un client LLM simple pour Emacs
 ...
 * [chatAir](https://github.com/flyun/chatair) - âï¸A native Android client for OpenAI and Gemini âï¸OpenAI and Gemini's native Android client
 ...
 * [Hello-Python](https://github.com/mouredev/hello-python) - Course to learn the Python programming language from scratch and for beginners. Over 30 classes, 25 hours of video, code, and chat group. From its fundamentals to creating a Backend API with a database and more...
 ...
 * [leedl-tutorial](https://github.com/datawhalechina/leedl-tutorial) - Input: "ãæå®æ¯æ·±åº¦å­¦ä¹ æç¨ãï¼PDFä¸è½½å°åï¼https://github.com/datawhalechina/leedl-tutorial/releases"Output: "ãLi Hongyi Deep Learning Tutorialãï¼PDF download link: https://github.com/datawhalechina/leedl-tutorial/releases"
 ...
 * [bilingual_book_maker](https://github.com/yihong0618/bilingual_book_maker) - Create bilingual e-books using AI translation.
 ...
 * [OpenAGI](https://github.com/agiresearch/openagi) - OpenAGI: When Legal Master of Laws Meets Domain Experts
 ...
 * [openai-forward](https://github.com/beidongjiedeguang/openai-forward) - ð A forwarding service designed specifically for large language models Â· Deploy your personal AI agent with just one click Â· LLM Proxy Â· OpenAI API Reverse Proxy
 ...
 * [ChatIE](https://github.com/cocacola-lab/chatie) - The online version is temporarily unavailable because we cannot afford the key. You can clone and run it locally. Note: we set defaul openai key. If keys exceed plan and are invalid, please tell us. The response speed depends on openai. ( sometimes, the of
 ...
 * [Sunsimiao](https://github.com/x-d-lab/sunsimiao) - ð¿Sunsimiao Chinese Medical Large Model: Providing safe, reliable, and inclusive Chinese medical large model.
 ...
 * [MaxKB](https://github.com/1panel-dev/maxkb) - ð Knowledge base question and answer system based on large language models and RAG. Ready to use, model-neutral, flexible arrangement, supports quick embedding into third-party business systems.
 ...
 * [new-api](https://github.com/quantumnous/new-api) - AI model interface management and distribution system, supports converting multiple large models into a unified format for calling, supports formats such as OpenAI, Claude, etc., can be used for internal management and distribution channels by individuals or enterprises, this project is based on the secondary development of One API. ð¥ The next-generation LLM gateway and AI asset management system supports multiple languages.
 ...
 * [Rankify](https://github.com/datascienceuibk/rankify) - ð¥ Rankify: A Comprehensive Python Toolkit for Retrieval, Re-Ranking, and Retrieval-Augmented Generation ð¥. Our toolkit integrates 40 pre-retrieved benchmark datasets and supports 7+ retrieval techniques, 24+ state-of-the-art Reranking models, and multiple
 ...
 * [llama](https://github.com/facebookresearch/llama) - CÃ³digo de inferencia para modelos LLaMA
 ...
 * [Auto-GPT](https://github.com/torantulino/auto-gpt) - Advanced Games Engineering Project - Cubic Voxel Game Maker
 ...
 * [gptproxy](https://github.com/xicilion/gptproxy) - Use the GitLab API key to act as a proxy for the OpenAI API.
 ...
 * [vscode-chatgpt](https://github.com/gencay/vscode-chatgpt) - An integration of OpenAI ChatGPT with Visual Studio Code that is not officially supported.
 * [chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo) - A demonstration repository utilizing the OpenAI API.
 ...
 * [M5Unified_StackChan_ChatGPT](https://github.com/robo8080/m5unified_stackchan_chatgpt) - This is the "ChatGPT API-equipped AI stack-chan".
 ...
 * [chatgpt-dingtalk](https://github.com/eryajf/chatgpt-dingtalk) - ð DingTalk & ð¤ GPT-3.5 boost your work efficiency directly ð through private and group chats, one-on-one and group chat modes, role-playing, and image creation ð.
 * [go-openai](https://github.com/sashabaranov/go-openai) - OpenAI ChatGPT, GPT-3, GPT-4, DALLÂ·E, Whisper API wrapper for Go
 * [feishu-chatgpt](https://github.com/leizhenpeng/feishu-chatgpt) - ðFeishu Ã (GPT-3.5 + DALLÂ·E + Whisper) = Flying work experience ð Voice conversation, role-playing, multi-topic discussion, image creation, table analysis, document export ð
 ...
 * [openai-gpt-dev-notes-for-cn-developer](https://github.com/easychen/openai-gpt-dev-notes-for-cn-developer) - How to quickly develop an OpenAI/GPT application: Notes from Chinese developers
 ...
 * [polyglot](https://github.com/liou666/polyglot) - ð¤ï¸ Desktop AI language practice application
 ...
 * [feishu-openai](https://github.com/connectai-e/feishu-openai) - Input: ð Feishu Ã (GPT-4 + DALLÂ·E-3 + Whisper) = An extraordinary work experience ð Voice conversation, role-playing, multi-topic discussions, image creation, spreadsheet analysis, document export ð
 ...
 * [Dingtalk-OpenAI](https://github.com/connectai-e/dingtalk-openai) - Input: ð DingTalk & ð¤ GPT-3.5 boost your work efficiency directly ð Private chat, group chat, one-on-one conversation, role-playing, image creation ð
 ...
 * [ant-codeAI](https://github.com/sparrow-js/ant-codeai) - AI generates code.
 ...
 * [generative-manim](https://github.com/360macky/generative-manim) - ð¨ GPT for video generation â¡ï¸Translated Output:ð¨ GPT for video generation â¡ï¸
 ...
 * [APIPark](https://github.com/apiparklab/apipark) - ð¦APIPark is the #1 open-source AI Gateway and Developer Portal, enabling you to easily manage, integrate, and deploy AI and API services. APIPark seamlessly connects with various large AI models and packages these AI capabilities into APIs for easy invocat
 ...
 * [hydra](https://github.com/ory/hydra) - The only web-scale, fully customizable OpenID Certifiedâ¢ OpenID Connect and OAuth2 Provider in the world. Become an OpenID Connect and OAuth2 Provider over night. Written in Go, cloud native, headless, API-first. Available as a service on Ory Network and f
 ...
 * [LocalAGI](https://github.com/mudler/localagi) - LocalAGI is a powerful, self-hostable AI Agent platform designed for maximum privacy and flexibility. A complete drop-in replacement for OpenAI's Responses APIs with advanced agentic capabilities. No clouds. No data leaks. Just pure local AI that works on
 ...
 * [AutoGPT-FR](https://github.com/mikiane/autogpt-fr) - French version of Auto GPT
 * [DeepSpeedExamples](https://github.com/microsoft/deepspeedexamples) - Examples of models implemented using DeepSpeed
 ...
 * [galai](https://github.com/paperswithcode/galai) - API model for GALACTICA
 * [gost-install.ipynb](https://github.com/lewangdev/gost-install.ipynb) - Install GOST through Jupyter Notebook.
 ...
 * [WTF-JavaScript](https://github.com/wtfacademy/wtf-javascript) - I am currently relearning JavaScript to solidify some details and also writing a "WTF JavaScript Minimalist Guide" for newcomers to learn.
 ...
 * [ChatGPT-Feishu](https://github.com/bestony/chatgpt-feishu) - ChatGPT bot prepared for Feishu
 ...
 * [run-wild](https://github.com/refcell/run-wild) - Amplify GPT-4 Environment Accessibility
 ...
 * [chatgpt-web](https://github.com/869413421/chatgpt-web) - A private web program implemented based on ChatGPT3.5 API.
 ...
 * [wechatgpt](https://github.com/houko/wechatgpt) - WechatGPT is a Golang-based ChatGPT bot that can be deployed using Docker. Currently, it supports WeChat and Telegram.
 * [xiaogpt.git](https://github.com/yihong0618/xiaogpt.git) - bilibili backend source code
 * [wechat-chatGPT](https://github.com/gtoxlili/wechat-chatgpt) - Implementing ChatGPT for WeChat Official Account's passive response interface.
 ...
 * [Entrepreneur-GPT](https://github.com/torantulino/entrepreneur-gpt) - I'm sorry, but "GUJAM" is not a word or phrase in any language that I am aware of. Therefore, I cannot provide a translation for this input.
 * [ChatGPTforRhino](https://github.com/4kk11/chatgptforrhino) - "I implemented a GUI for chatgptforrhino and made it look similar! I also put it on GitHub!"
 ...
 * [haoel.github.io](https://github.com/haoel/haoel.github.io) - A few days ago, I saw that Brother Rat updated the online document. I also want to share how I solved the problem of not being able to log in or use ChatGPT and New Bing even with a VPN: Gost + Cloudflare Warp. The configuration is also relatively simple. (1/n)
 ...
 * [MathGPT](https://github.com/meiyulee/mathgpt) - Free digital-driven mathematical model artificial intelligence | Establish mathematical models for your numbers |
 ...
 * [chatchan-dist](https://github.com/easychen/chatchan-dist) - Chat Sauce independent deployment version, docker solution comes with proxy.
 ...
 * [binary-dist](https://github.com/poslogithub/binary-dist) - For distribution of executable binaries.
 ...
 * [ai-review.vim](https://github.com/yuki-yano/ai-review.vim) - Tally your code, fast.
 ...
 * [explain-source-code-by-chatgpt](https://github.com/cuishuang/explain-source-code-by-chatgpt) - ðð» ChatGPT explains the source code of a well-known Go project.
 * [ChatGPT_principle_fine-tuning_code_paper](https://github.com/julycoding/chatgpt_principle_fine-tuning_code_paper) - The initial version of this "ChatGPT Resource Library (Principles/Fine-tuning/Code/Papers)" comes from the highly popular ChatGPT series on July's CSDN blog, with a reading count of up to 500,000. Co-initiated by the students of July's ChatGPT Principles Course, it was officially released to the public in early June.
 ...
 * [ChatGPT-Virtual-Live](https://github.com/smallnew666/chatgpt-virtual-live) - Input: ChatGPT virtual anchor, supports Bilibili, Douyin, and Video Number.Output: ChatGPT virtual anchor, supports Bilibili, Douyin, and Video Number.
 ...
 * [Chat-CodeReview](https://github.com/nangongchengfeng/chat-codereview) - Input: ChatGPT integrates with Gitlab to automatically audit code and provide comments.
 * [NeuroGPT](https://github.com/em1tsan/neurogpt) - Free ChatGPT 3.5 / ChatGPT 4
 ...
 * [feishu-chatgpt](https://github.com/1130600015/feishu-chatgpt) - A Feishu application integrated with ChatGPT.
 * [midjourney_turbo](https://github.com/chazzjimel/midjourney_turbo) - Input: ChatGPT-on-WeChat's MJ drawing plugin, with usage restrictions, GPT keyword enhancement, image synthesis, and generating images based on pictures.
 * [humanify](https://github.com/jehna/humanify) - Un-minify Javascript code using ChatGPT
 * [careerboost](https://github.com/dmswl98/careerboost) - ð chatGPT Resume Editing Service
 ...
 * [GPT-WEB-JAVA](https://github.com/a616567126/gpt-web-java) - Based on JDK8 AI chatbot! WeChat official account Midjourney drawing, card exchange, web support ChatGPT, Midjourney drawing, sd drawing, card exchange, easy payment, official account drainage, email registrationð¥
 ...
 * [hamulete](https://github.com/hoochanlon/hamulete) - National Taiwan University, National University of Singapore, Waseda University, University of Tokyo, Academia Sinica (Taiwan), as well as key universities and research institutions in China, social sciences, economics, mathematics, game theory, philosophy, and academic papers in the field of systems engineering, etc.
 ...
 * [zotero-gpt](https://github.com/muisedestiny/zotero-gpt) - GPT meets Zotero.
 ...
 * [GalTransl](https://github.com/cx2333-gt/galtransl) - Support for Galgame automated translation solutions using large language models such as GPT-3.5/GPT-4/Newbing/Sakura.
 ...
 * [chatgpt-next](https://github.com/xcatliu/chatgpt-next) - WeChat-style ChatGPT, built using Next.js, is the best choice for private deployment!
 * [wechatSDK](https://github.com/kawika-git/wechatsdk) - WeChat robot is an innovative project developed based on Python 3.11. By combining the ChatGPT model and the native WeChat API, it provides users with intelligent chatting, automatic drawing, automatic posting on Moments, automatic posting on Video Accounts, and other diverse API integration services, aiming to enhance daily communication efficiency and fun.
 ...
 * [ChatGPT-miniprogram](https://github.com/leon-fong/chatgpt-miniprogram) - ð¤ ChatGPT Mini Program
 ...
 * [Chatgpt-Makes-Money](https://github.com/xiaoming2028/chatgpt-makes-money) - Input: Must-see tips for making money with ChatGPT as a side job, ChatGPT money-making secrets, ChatGPT from beginner to expertOutput: Must-see tips for making money with ChatGPT as a side job, ChatGPT money-making secrets, ChatGPT from beginner to expert
 ...
 * [ChatGPT-Mirror](https://github.com/dairoot/chatgpt-mirror) - ð One-click deployment of your own ChatGPT mirror site
