 ...
 * [ChatGPT-On-CS](https://github.com/lrhh123/chatgpt-on-cs) - åºäºå¤§æ¨¡åçæºè½å¯¹è¯å®¢æå·¥å·ï¼æ¯æå¾®ä¿¡ãåçãåå©åå©ãæé³ä¼ä¸å·ãæé³ãæåºãå¾®åèå¤©ãå°çº¢ä¹¦ä¸ä¸å·è¿è¥ãå°çº¢ä¹¦ãç¥ä¹ç­å¹³å°æ¥å¥ï¼å¯éæ© GPT3.5/GPT4.0/ æäººç¾å®ç®± ï¼åç»­ä¼æ¯ææ´å¤å¹³å°ï¼ï¼è½å¤çææ¬ãè¯­é³åå¾çï¼éè¿æä»¶è®¿é®æä½ç³»ç»åäºèç½ç­å¤é¨èµæºï¼æ¯æåºäºèªæç¥è¯åºå®å¶ä¼ä¸ AI åºç¨ã
 ...
 * [openlrc](https://github.com/zh-plus/openlrc) - Transcribe and translate voice into LRC file using Whisper and LLMs (GPT, Claude, et,al). ä½¿ç¨whisperåLLM(GPTï¼Claudeç­)æ¥è½¬å½ãç¿»è¯ä½ çé³é¢ä¸ºå­å¹æä»¶ã
 * [wrest-chat](https://github.com/opentdp/wrest-chat) - å¾®ä¿¡æºå¨äººï¼PC Wechat Api/Bot/Sdkï¼åç½® WEB ç®¡ççé¢ï¼å¯æ¥å¥GPTãGemini ãæç«ãæå¿ãæ··å ãéä¹åé®ç­å¤§è¯­è¨æ¨¡å
 * [chatbot-app](https://github.com/chatbot-all/chatbot-app) - mobile private ChatGPT application, supporting GPT3, GPT4 & Gemini Pro models.  æ¥æèªå·±çç§»å¨ç«¯ ChatGPT/Gemini åºç¨ã
 * [ChatGPT-On-CS](https://github.com/cs-lazy-tools/chatgpt-on-cs) - åºäºå¤§æ¨¡åçæºè½å¯¹è¯å®¢æå·¥å·ï¼æ¯æå¾®ä¿¡ãåçãåå©åå©ãæé³ä¼ä¸å·ãæé³ãæåºãå¾®åèå¤©ãå°çº¢ä¹¦ä¸ä¸å·è¿è¥ãå°çº¢ä¹¦ãç¥ä¹ç­å¹³å°æ¥å¥ï¼å¯éæ© GPT3.5/GPT4.0/ æäººç¾å®ç®± ï¼åç»­ä¼æ¯ææ´å¤å¹³å°ï¼ï¼è½å¤çææ¬ãè¯­é³åå¾çï¼éè¿æä»¶è®¿é®æä½ç³»ç»åäºèç½ç­å¤é¨èµæºï¼æ¯æåºäºèªæç¥è¯åºå®å¶ä¼ä¸ AI åºç¨ã
 ...
 * [gpt-assistant-android](https://github.com/skythinker616/gpt-assistant-android) - åè´¹çChatGPT APIçå®åè¯­é³å©æï¼å¯ç¨é³éé®å¤èµ·å¹¶è¿è¡è¯­é³äº¤æµï¼æ¯æèç½ãVisionæç§è¯å¾ãæé®æ¨¡æ¿ç­åè½ | A free ChatGPT API voice assistant for Android, activated via volume keys for voice interaction, supporting features such as network connectivity, Vision photo recognition, and question templates.
 ...
 * [nlux](https://github.com/nlkitai/nlux) - The ð£ð¼ðð²ð¿ð³ðð¹ Conversational AI JavaScript Library
 ...
 * [discord-llm-chatbot](https://github.com/jakobdylanc/discord-llm-chatbot) - llmcord.py â¢ Talk to LLMs with your friends!
 ...
 * [GURU-Ai](https://github.com/guru322/guru-ai) - A SIMPLE YET COMPLICATED AI Chat Robot LOADED WITH FEATURESð©
 ...
 * [Whatsapp-Ai-BOT](https://github.com/yesbhautik/whatsapp-ai-bot) - Introducing the AI Chatbot for WhatsApp - a cutting-edge solution powered by OpenAI's ChatGPT, Playground & DALLÂ·E. This innovative chatbot has been developed using NodeJS technology and leverages the latest advancements in AI to provide an unmatched user experience for WhatsApp today!
 * [fastui-chat](https://github.com/shroominic/fastui-chat) - ð¬ minimalistic ChatBot Interface in pure python
 * [pokitoki](https://github.com/nalgeon/pokitoki) - Humble GPT Telegram Bot
 * [openai-chat-api-workflow](https://github.com/yohasebe/openai-chat-api-workflow) - ð© An Alfred 5 Workflow for using OpenAI Chat API to interact with GPT-3.5/GPT-4 ð¤ð¬ It also allows image generation ð¼ï¸, image understanding ð, speech-to-text conversion ð¤, and text-to-speech synthesis ð
 ...
 * [bot-on-anything](https://github.com/zhayujie/bot-on-anything) - Connect AI models (like ChatGPT-3.5/4.0, Baidu Yiyan, New Bing, Bard) to apps (like Wechat, public account, DingTalk, Telegram,  QQ).  å° ChatGPTãå¿åºãæå¿ä¸è¨ãè°·æ­Bard ç­å¯¹è¯æ¨¡åè¿æ¥åç±»åºç¨ï¼å¦å¾®ä¿¡ãå¬ä¼å·ãQQãTelegramãGmailãSlackãWebãä¼ä¸å¾®ä¿¡ãé£ä¹¦ãééç­ã
 ...
 * [repopack](https://github.com/yamadashy/repopack) - ð¦ Repopack is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, and Gemini.
 ...
 * [lobe-vidol](https://github.com/lobehub/lobe-vidol) - ð§¸ Lobe Vidol - Making Virtual Idols Accessible for EveryOne
 ...
 * [builderbot](https://github.com/codigoencasa/builderbot) - ð¤ Crear Chatbot WhatsApp en minutos. Ãnete a este proyecto OpenSource
 * [hey](https://github.com/lnxpy/hey) - ð¬ AI-Powered Pair Programming Friend!
 ...
 * [design-studio](https://github.com/tiledesk/design-studio) - Tiledesk's open-source visual, no-code designer where LLM/GPT AI meets a flexible 'graph' approach. Create conversations and automations effortlessly â a Voiceflow and Botpress alternative.
 * [chatgpt-voice](https://github.com/sonngdev/chatgpt-voice) - Have a conversation with ChatGPT. Casually ð ð¤ â¡ï¸
 ...
 * [OpsPilot](https://github.com/weops-lab/opspilot) - OpsPilot is an open source intelligent operation and maintenance assistant based on deep learning and LLM technology developed by the WeOps team. OpsPilotæ¯WeOpså¢éå¼æºçä¸ä¸ªåºäºæ·±åº¦å­¦ä¹ ä¸LLMææ¯çæºè½è¿ç»´å©ç
 ...
 * [Starmoon](https://github.com/starmoonai/starmoon) - An open source voice-enabled, compact, empathic AI hardware + software ð¤ framework for companionship, entertainment, education, pediatric care, IoT robotics applications, AI-enhanced robotics application services, research, and DIY robotics kit development using Python, NextJs, Arduino, ESP32, LLMs (GPT), STT, TTS, Emotion Analysis, AI agent
 ...
 * [repomix](https://github.com/yamadashy/repomix) - ð¦ Repomix (formerly Repopack) is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, and Gemini.
 * [LangBot](https://github.com/rockchinq/langbot) - åå QChatGPT ï¼ðé«ç¨³å®æ§ãð§©æ¯ææ©å±ãð¦å¤æ¨¡æç ChatGPT QQ / QQé¢é / One Bot æºå¨äººð¤ | æ¯æ OpenAI GPTãClaudeãGemini ProãDeepSeekãMoonshotï¼Kimiï¼ãgpt4freeãOne APIãOllamaãdify ç QQ / QQé¢é / OneBot æºå¨äºº / Agent å¹³å°
 ...
 * [ipranges](https://github.com/lord-alfred/ipranges) - ð¨ List all IP ranges from: Google (Cloud & GoogleBot), Bing (Bingbot), Amazon (AWS), Microsoft, Oracle (Cloud), GitHub, Facebook (Meta), OpenAI (GPTBot) and other with daily updates.
 ...
 * [NextChat](https://github.com/chatgptnextweb/nextchat) - â¨ Local and Fast AI Assistant. Support: Web | iOS | MacOS | Android |  Linux | Windows
 ...
 * [agents](https://github.com/livekit/agents) - A powerful framework for building realtime voice AI agents ð¤ðï¸ð¹
 ...
 * [llmcord](https://github.com/jakobdylanc/llmcord) - Make Discord your LLM frontend â Supports any OpenAI compatible API (Ollama, AI/ML API, LM Studio, vLLM, OpenRouter, xAI, Mistral, Groq and more)
 * [flock](https://github.com/onelevenvy/flock) - Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.ï¼Flock æ¯ä¸ä¸ªåºäºworkflowå·¥ä½æµçä½ä»£ç å¹³å°ï¼ç¨äºå¿«éæå»ºèå¤©æºå¨äººãRAGãAgentåMuti-Agentåºç¨ï¼éç¨ LangGraphãLangchainãFastAPI å NextJS æå»ºãï¼
 * [mastra](https://github.com/mastra-ai/mastra) - The TypeScript AI agent framework. â¡ Assistants, RAG, observability. Supports any LLM: GPT-4, Claude, Gemini, Llama.
 * [Robby-chatbot](https://github.com/yvann-ba/robby-chatbot) - AI chatbot ð¤ for chat with CSV, PDF, TXT files ð and YTB videos ð¥ | using Langchainð¦ | OpenAI | Streamlit â¡
 ...
 * [sanic-web](https://github.com/apconw/sanic-web) - ä¸ä¸ªè½»éçº§ãæ¯æå¨é¾è·¯ä¸æäºäºæ¬¡å¼åçå¤§æ¨¡ååºç¨é¡¹ç®(Large Model Data Assistant) æ¯æDeepSeek/Qwen2.5ç­å¤§æ¨¡å åºäº Dify ãOllama&VllmãSanic å Text2SQL ð ç­ææ¯æå»ºçä¸ç«å¼å¤§æ¨¡ååºç¨å¼åé¡¹ç®ï¼éç¨ Vue3ãTypeScript å Vite 5 æé ç°ä»£UIãå®æ¯æéè¿ ECharts ð å®ç°åºäºå¤§æ¨¡åçæ°æ®å¾å½¢åé®ç­ï¼å·å¤å¤ç CSV æä»¶ ð è¡¨æ ¼é®ç­çè½åãåæ¶ï¼è½æ¹ä¾¿å¯¹æ¥ç¬¬ä¸æ¹å¼æº RAG ç³»ç» æ£ç´¢ç³»ç» ðç­ï¼ä»¥æ¯æå¹¿æ³çéç¨ç¥è¯é®ç­ã
 * [evolution-api](https://github.com/evolutionapi/evolution-api) - Evolution API is an open-source WhatsApp integration API
 * [deepchat](https://github.com/thinkinaixyz/deepchat) - ð¬DeepChat - A smart assistant that connects powerful AI to your personal world
 * [AChat](https://github.com/aprilnea/achat) - ð AChat - An open-source/self-hosted/local-first AI platform, designed for enterprises and teams, perfectly combining powerful local processing capabilities with seamless remote synchronization.
 ...
 * [LangBot](https://github.com/langbot-app/langbot) - ð¤© Easy-to-use global IM bot platform designed for the LLM era / ç®åæç¨çå¤§æ¨¡åå³æ¶éä¿¡æºå¨äººå¼åå¹³å° â¡ï¸ Bots for QQ / QQé¢é / Discord / WeChatï¼ä¼ä¸å¾®ä¿¡ãä¸ªäººå¾®ä¿¡ï¼/ Telegram / é£ä¹¦ / éé / Slack ð§© Integrated with ChatGPTãDeepSeekãDifyãn8nãClaudeãGoogle GeminiãxAIãPPIOãOllamaãé¿éäºç¾ç¼ãSiliconFlowãQwenãMoonshotãSillyTravenãMCPãWeClone etc. LLM & Agent
 ...
 * [google-chatgpt-plugin](https://github.com/sogody/google-chatgpt-plugin) - @ykdojo awesome @ykdojo! there is already a google chatgpt plugin too  ð¤¯
 ...
 * [chat-todo-plugin](https://github.com/lencx/chat-todo-plugin) - â ChatGPT Plugin for managing a TODO list
 ...
 * [examples](https://github.com/pinecone-io/examples) - å¦æä½ å¯¹å¦ä½å¼åchatgpt pluginæå´è¶£ï¼æ¨èçä¸ä¸è¿ä¸ªè§é¢ï¼å®æ´çä»ç»äºï¼1. ä»ä¹æ¯chatgpt plugin2. å¦ä½å¼åä¸ä¸ªlangchainææ¡£æ¥è¯¢çchatgpt plugin3. å¦ä½å®è£è°è¯chatgpt pluginè§é¢ï¼ï¼
 ...
 * [transformers.js](https://github.com/xenova/transformers.js) - Run ð¤ Transformers in your browser!
 * [bob-plugin-openai-translator](https://github.com/yetone/bob-plugin-openai-translator) - åºäº ChatGPT API çææ¬ç¿»è¯ãææ¬æ¶¦è²ãè¯­æ³çº é Bob æä»¶ï¼è®©æä»¬ä¸èµ·è¿æ¥ä¸éè¦å·´å«å¡çæ°æ¶ä»£ï¼
 * [chatgpt-extension](https://github.com/iolivernguyen/chatgpt-extension) - Minimal require.js implements CommonJS
 * [docGPT](https://github.com/cesarhuret/docgpt) - ChatGPT directly within Google Docs as an Editor Add-on ð
 ...
 * [simpread](https://github.com/kenshin/simpread) - ç®æ¦ ( SimpRead ) - è®©ä½ ç¬é´è¿å¥æ²æµ¸å¼éè¯»çæ©å±
 * [chatgpt-wechat-landing-page](https://github.com/1cloudy/chatgpt-wechat-landing-page) - ä¸ä¸ª Chrome æµè§å¨æä»¶ï¼éè¿ ChatGPT æ¥èªå¨ååºå¾®ä¿¡ç§ä¿¡æç¾¤èä¸­ @ä½  çæ¶æ¯çæºè½èå¤©æºå¨äºº
 ...
 * [openai-translator](https://github.com/yetone/openai-translator) - åºäº ChatGPT API çåè¯ç¿»è¯æµè§å¨æä»¶åè·¨å¹³å°æ¡é¢ç«¯åºç¨    -    Browser extension and cross-platform desktop application for translation based on ChatGPT API.
 ...
 * [nextjs-chatgpt-app](https://github.com/enricoros/nextjs-chatgpt-app) - ð¬ Responsive chat application powered by OpenAI's GPT-4, with response streaming, code highlighting, various presets for developers. Using Next.js, React, Joy.
 ...
 * [butler.vim](https://github.com/lambdalisue/butler.vim) - ð« Your butler. A ChatGPT like Vim/Neovim plugin that communicate with the OpenAI APIs
 * [AgentGPT](https://github.com/reworkd/agentgpt) - ð¤ Assemble, configure, and deploy autonomous AI Agents in your browser.
 ...
 * [AutoGPT-Next-Web](https://github.com/dogtiti/autogpt-next-web) - ð¤ Assemble, configure, and deploy autonomous AI Agents in your browser.ä¸é®åè´¹é¨ç½²ä½ çç§äººAutoGPT ç½é¡µåºç¨
 * [chatgpt-plugin-ts](https://github.com/transitive-bullshit/chatgpt-plugin-ts) - Everything you need to start building ChatGPT Plugins in JS/TS ð¥
 ...
 * [kubectl-ai](https://github.com/sozercan/kubectl-ai) - â¨ Kubectl plugin for OpenAI GPT
 ...
 * [chatgpt-plugin](https://github.com/solana-labs/chatgpt-plugin) - ð§¬@Solanalabs has developed an open-source reference implementation for a ChatGPT plugin.ð§¬The availability of #ChatGPT plugins will enable #Solana users to verify their wallet balances, transfer tokens, and acquire NFTs.ð½INFO
 ...
 * [chatgpt-plugin](https://github.com/cloudflare/chatgpt-plugin) - Build ChatGPT plugins with Cloudflare's Developer Platform ð¤
 ...
 * [openai-plugin-fastapi](https://github.com/azure-samples/openai-plugin-fastapi) - Scott Guthrie ã®åºèª¿è¬æ¼ã§ç´¹ä»ããã OpenAI ãã©ã°ã¤ã³ã®ãµã³ãã«ã³ã¼ãChatGPT Plugin Quickstart using Python and FastAPI #MSBuild
 * [ChatGPT-Plugins-Searchable](https://github.com/banbri/chatgpt-plugins-searchable) - Make your ChatGPT Plugin store searchable.è®©ä½ ç ChatGPT æä»¶ååºæ¯ææç´¢ãhttps://greasyfork.org/scripts/466901-chatgpt-plugins-searchable
 ...
 * [duckduckgpt](https://github.com/kudoai/duckduckgpt) - ð¤ DuckDuckGo add-on that brings the magic of ChatGPT to search results (powered by GPT-4!)
 * [bravegpt](https://github.com/kudoai/bravegpt) - ð¦ Brave Search add-on that brings the magic of ChatGPT to search results (powered by GPT-4!)
 ...
 * [openai-translator](https://github.com/openai-translator/openai-translator) - åºäº ChatGPT API çåè¯ç¿»è¯æµè§å¨æä»¶åè·¨å¹³å°æ¡é¢ç«¯åºç¨    -    Browser extension and cross-platform desktop application for translation based on ChatGPT API.
 ...
 * [continue](https://github.com/continuedev/continue) - â© the open-source autopilot for software developmentâa VS Code extension that brings the power of ChatGPT to your IDE
 ...
 * [meeper](https://github.com/pas1ko/meeper) - Meeper ð - is your secretary for any in-browser conference.
 ...
 * [chatgpt-plugins](https://github.com/copilot-us/chatgpt-plugins) - Official ChatGPT Pluginsð§©
 ...
 * [github-chatgpt-plugin](https://github.com/aavetis/github-chatgpt-plugin) - ChatGPT plugin to interact with anything in GitHub. Install âChat With Codeâ from the ChatGPT plugin store.
 ...
 * [Free-personal-AI-Assistant-with-plugin](https://github.com/intelligenzaartificiale/free-personal-ai-assistant-with-plugin) - ð¤ Would you like to use GPT4 with Plugins but don't want to pay $20/month? This is the solution!  With this repository you can have free clone of ChatGPT with plugin
 ...
 * [LLMBot](https://github.com/llmkira/llmbot) - æä»¶æ¦å¿µååæº /// Agents System/èªå³ç­ |ç±» ChatGpt æä»¶ç³»ç»| Gpt-3.5/Gpt-4 |Assistant | ð± Cross-Platform | ð¦¾ Async | ð Plugin System
 * [bob-plugin-openai-translator](https://github.com/openai-translator/bob-plugin-openai-translator) - åºäº ChatGPT API çææ¬ç¿»è¯ãææ¬æ¶¦è²ãè¯­æ³çº é Bob æä»¶ï¼è®©æä»¬ä¸èµ·è¿æ¥ä¸éè¦å·´å«å¡çæ°æ¶ä»£ï¼Licensed under CC BY-NC-SA 4.0
 * [Openaibot](https://github.com/llmkira/openaibot) - â¡ï¸ Build Your Own AssistantBot|ð§ Discord/Slack/Kook/Telegram |ð å¤å» ChatGpt æ¶æ |â ToolCall/FunctionCall|ð  Plugin Support | ð» sh & docker-compose
 ...
 * [chatgpt-google-summary-extension](https://github.com/sparticleinc/chatgpt-google-summary-extension) - Chrome extension to view ChatGPT summaries alongside Google search results and YouTube videos, also supports Yahoo! ãã¥ã¼ã¹ãPubMedãPMCãNewsPicksãGithubãNikkeiã BingãGoogle Patents, and any page summary.
 ...
 * [writely](https://github.com/anc95/writely) - â¤ï¸âð¥ A chrome extension as an alternative to Notion AI that goes beyond Notion AI. | ä¸ä¸ªæ¿ä»£ Notion AI çæµè§å¨æä»¶ï¼ä¸æ­¢äº Notion AI
 ...
 * [nonebot_plugin_naturel_gpt](https://github.com/kromiose/nonebot_plugin_naturel_gpt) - ä¸ä¸ªåºäºNoneBotæ¡æ¶çAièå¤©æä»¶ï¼å¯¹æ¥OpenAiææ¬çææ¥å£ï¼å®ç°äºæºå¨äººçäººæ ¼ èªå®ä¹/åæ¢ï¼èå¤©è®°å¿ç­åè½
 ...
 * [raycast-openai-translator](https://github.com/openai-translator/raycast-openai-translator) - åºäº ChatGPT API ç Raycast ç¿»è¯æä»¶ - Raycast extension for translation based on ChatGPT API.
 ...
 * [nonebot-plugin-bilichat](https://github.com/well2333/nonebot-plugin-bilichat) - ä¸ä¸ªéè¿ OpenAI æ¥å¯¹bç«è§é¢è¿è¡æ»ç»çå¤åè½ Bç«è§£ææä»¶
 ...
 * [crawlee-python](https://github.com/apify/crawlee-python) - CrawleeâA web scraping and browser automation library for Python to build reliable crawlers. Extract data for AI, LLMs, RAG, or GPTs. Download HTML, PDF, JPG, PNG, and other files from websites. Works with BeautifulSoup, Playwright, and raw HTTP. Both headful and headless mode. With proxy rotation.
 ...
 * [ChatLLM-Web](https://github.com/ryan-yang125/chatllm-web) - ð£ï¸ Chat with LLM like Vicuna totally in your browser with WebGPU, safely, privately, and with no server. Powered by web llm.
 ...
 * [bob-plugin-openai-polisher](https://github.com/openai-translator/bob-plugin-openai-polisher) - ä½¿ç¨ OpenAI API ç»ææ¬è¿è¡æ¶¦è²åè¯­æ³çº éç Bob æä»¶ï¼å®ç¾ä»£æ¿ Grammarlyï¼Licensed under CC BY-NC-SA 4.0
 ...
 * [codecompanion.nvim](https://github.com/olimorris/codecompanion.nvim) - â¨ A Copilot Chat experience in Neovim, complete with inline assistant. Supports Anthropic, Gemini, Ollama and OpenAI LLMs
 ...
 * [parrot.nvim](https://github.com/frankroeder/parrot.nvim) - parrot.nvim ð¦ - the plugin that brings stochastic parrots to Neovim. This is a gp.nvim-fork focused on simplicity.
 ...
 * [AutoGPT-Next-Web](https://github.com/connectai-e/autogpt-next-web) - ð¤ Assemble, configure, and deploy autonomous AI Agents in your browser.ä¸é®åè´¹é¨ç½²ä½ çç§äººAutoGPT ç½é¡µåºç¨
 ...
 * [AutoGPT-Next-Web](https://github.com/elricliu/autogpt-next-web) - ð¤ Assemble, configure, and deploy autonomous AI Agents in your browser.ä¸é®åè´¹é¨ç½²ä½ çç§äººAutoGPT ç½é¡µåºç¨
 ...
 * [solon](https://github.com/opensolon/solon) - ð¥ Java enterprise application development framework for full scenario: Restrained, Efficient, Open, Ecologicalll!!! 700% higher concurrency 50% memory savings Startup is 10 times faster. Packing 90% smaller; Compatible with java8 ~ java24. (Replaceable spring)
 ...
 * [notte](https://github.com/nottelabs/notte) - ð¥ Opensource browser using agent
 ...
 * [ai-web-extensions](https://github.com/adamlui/ai-web-extensions) - ð¤ AI browser extensions & userscripts to augment your web experience
 * [PotPlayer_ChatGPT_Translate](https://github.com/felix3322/potplayer_chatgpt_translate) - è¿ä¸ªå®æ¶å­å¹ç¿»è¯æä»¶å°OpenAIçChatGPT APIï¼æä»»ä½å·æç¸åAPIè°ç¨æ¹æ³çæ¨¡åï¼éæå°PotPlayerä¸­ãå®ä½¿ä½ å¨è§çè§é¢æ¶è½å¤å®æ¶ç¿»è¯å­å¹ï¼ä»èæç ´è¯­è¨éç¢ï¼æåä½ çè§çä½éªã This real-time subtitle translation plugin integrates OpenAI's ChatGPT API (or any model with the same API calling method) into PotPlayer. It enables you to translate subtitles on-the-fly while watching videos.
 ...
 * [mcp-unity](https://github.com/codergamester/mcp-unity) - Unity plugin for integrating Model Context Protocol (MCP) with the Unity Editor â designed for AI-assisted development and OpenAI, Gemini and Claude interoperability
 ...
 * [PyChatGPT](https://github.com/rawandahmad698/pychatgpt) - â¡ï¸ Python client for the unofficial ChatGPT API with auto token regeneration, conversation tracking, proxy support and more.
 ...
 * [chatgpt-gsheets](https://github.com/amrrs/chatgpt-gsheets) - [new] #chatgpt in sheets! ð¤¯integrate the #chatgpt #api in @googlesheets in a few clicks, @1littlecoder shows you how!use cases: #seo, #socialmedia, #marketing, you name it! ð¥- tutorial:  code:  cost: $2/million tokens! ð
 ...
 * [chatgpt-api](https://github.com/transitive-bullshit/chatgpt-api) - Node.js client for the official ChatGPT API. ð¥
 * [ChatGPT-Next-Web](https://github.com/yidadaa/chatgpt-next-web) - ä¸é®æ¥æä½ èªå·±ç ChatGPT ç½é¡µæå¡ã One-Click to deploy your own ChatGPT web UI.
 ...
 * [bing-chat](https://github.com/transitive-bullshit/bing-chat) - Node.js client for Bing's new AI-powered search. It's like ChatGPT on steroids ð¥
 * [aicommits](https://github.com/nutlope/aicommits) - A CLI that writes your git commit messages for you with AI
 * [opencommit](https://github.com/di-sukharev/opencommit) - GPT CLI to auto-generate impressive commits in 1 second ð¤¯ð«
 ...
 * [client](https://github.com/openai-php/client) - â¡ï¸ OpenAI PHP is a supercharged community-maintained PHP API client that allows you to interact with OpenAI API.
 ...
 * [README-AI](https://github.com/eli64s/readme-ai) - ð CLI tool that generates beautiful and informative README Markdown files. Powered by OpenAI's GPT APIs ð«
 * [openai-powershell-samples](https://github.com/dfinke/openai-powershell-samples) - ð Launched my @OpenAI/@Azure PowerShell Samples! With the PowerShellAI module, you'll have the power of ChatGPT at your fingertips. Explore the samples in Polyglot Interactive Notebooks. Let's redefine what's possible with AI! ð  #PowerShell #MSBuild
 ...
 * [ChatGPT-Midjourney](https://github.com/licoy/chatgpt-midjourney) - ð¨ ä¸é®æ¥æä½ èªå·±ç ChatGPT+Midjourney ç½é¡µæå¡ \ Own your own ChatGPT+Midjourney web service with one click
 * [termGPT](https://github.com/tcapelle/termgpt) - A simple wrapper to call openAI's chatGPT on the terminal written in Python
 * [Chat2DB](https://github.com/alibaba/chat2db) - ð¥ ð¥ ð¥ An intelligent and versatile general-purpose SQL client and reporting tool for databases which integrates ChatGPT capabilities.(æºè½çéç¨æ°æ®åºSQLå®¢æ·ç«¯åæ¥è¡¨å·¥å·)
 ...
 * [chatgpt.js](https://github.com/chatgptjs/chatgpt.js) - ð¤ A powerful client-side JavaScript library for ChatGPT
 ...
 * [SaaS-Template-GPT](https://github.com/wasp-lang/saas-template-gpt) - ð Wasp- immediately started with a SaaS template that includes social/email login, GPT/Stripe integration, cron jobs, ... â super fast startâ¡ï¸- `wasp db` CLI command is also a nice touch, immediately starts a local Postgres db in the background
 * [openai-cli](https://github.com/janlay/openai-cli) - A universal cli for OpenAI, written in BASH.
 * [Chat2DB](https://github.com/chat2db/chat2db) - ð¥ ð¥ ð¥ An intelligent and versatile general-purpose SQL client and reporting tool for databases which integrates ChatGPT capabilities.(æºè½çéç¨æ°æ®åºSQLå®¢æ·ç«¯åæ¥è¡¨å·¥å·)
 * [gpt-web-terminal](https://github.com/ltyzzzxxx/gpt-web-terminal) - â¨ Open ChatGPT with Programmer's Approach! GPT Terminal is a platform that allows you to communicate with GPT in a terminal.
 ...
 * [lobe-commit](https://github.com/lobehub/lobe-commit) - ð Lobe Commit is a CLI tool that uses Langchain/ChatGPT to generate Gitmoji-based commit messages
 ...
 * [lobe-chat](https://github.com/lobehub/lobe-chat) - ð¤ Lobe Chat - an open-source, extensible (Function Calling), high-performance chatbot framework. It supports one-click free deployment of your private ChatGPT/LLM web application.
 ...
 * [unit-runtime](https://github.com/unit-mesh/unit-runtime) - Unit Runtime æ¯ä¸ä¸ª ChatGPT ç­ AI ä»£ç çè¿è¡ç¯å¢ï¼å¯ä¸é®å¯å¨å¹¶å®æ¶äº¤äºï¼å¸®å©æ¨å¿«éæå»ºåæµè¯ AI ä»£ç ãUnit Runtime is an efficient and user-friendly AI code execution environment that allows for one-click startup and real-time interaction, helping you quickly build and test AI code.
 ...
 * [ollama-webui](https://github.com/ollama-webui/ollama-webui) - ChatGPT-Style Responsive Chat Web UI Client (GUI) for Ollama ð¦
 * [BibiGPT-v1](https://github.com/jimmylv/bibigpt-v1) - BibiGPT v1 Â· one-Click AI Summary for Audio/Video & Chat with Learning Content: Bilibili | YouTube | Tweetä¸¨TikTokä¸¨Dropboxä¸¨Google Driveä¸¨Local files | Websitesä¸¨Podcasts | Meetings | Lectures, etc. é³è§é¢åå®¹ AI ä¸é®æ»ç» & å¯¹è¯ï¼åå©åå©ä¸¨YouTubeä¸¨æ¨ç¹ä¸¨å°çº¢ä¹¦ä¸¨æé³ä¸¨å¿«æä¸¨ç¾åº¦ç½çä¸¨é¿éäºçä¸¨ç½é¡µä¸¨æ­å®¢ä¸¨ä¼è®®ä¸¨æ¬å°æä»¶ç­ (å BiliGPT çæµç¥å¨ & AIè¯¾ä»£è¡¨)
 ...
 * [MoneyPrinterTurbo](https://github.com/harry0703/moneyprinterturbo) - å©ç¨AIå¤§æ¨¡åï¼ä¸é®çæé«æ¸ç­è§é¢ Generate short videos with one click using AI LLM.
 * [zap-gpt](https://github.com/marcusgoncalvess/zap-gpt) - Este projeto explora a integraÃ§Ã£o do ChatGPT com o WhatsApp, transformando o chatbot em um assistente virtual capaz de realizar tarefas como falar com amigos, responder a perguntas de clientes, e muito mais, com um toque de humanizaÃ§Ã£o nas conversas.
 * [zap-gpt-free](https://github.com/marcusgoncalvess/zap-gpt-free) - Este projeto explora a integraÃ§Ã£o do ChatGPT com o WhatsApp, transformando o chatbot em um assistente virtual capaz de realizar tarefas como falar com amigos, responder a perguntas de clientes, e muito mais, com um toque de humanizaÃ§Ã£o nas conversas.
 * [chatAir](https://github.com/flyun/chatair) - âï¸A native Android client for OpenAI and Gemini âï¸OpenAI å Gemini çåçå®åå®¢æ·ç«¯
 * [matrix-chatgpt-bot](https://github.com/matrixgpt/matrix-chatgpt-bot) - Talk to ChatGPT via any Matrix client!
 * [lobe-cli-toolbox](https://github.com/lobehub/lobe-cli-toolbox) - ðª Lobe CLI Toolbox - AI CLI Toolbox, enhancing git commit and i18n workflow efficiency
 ...
 * [json-translator](https://github.com/mololab/json-translator) - jsontt ð¡ - AI JSON Translator with GPT + other FREE translation modules to translate your json/yaml files into other languages â Check Readme â Supports GPT / DeepL / Google / Bing / Libre / Argos
 ...
 * [tenere](https://github.com/pythops/tenere) - ð¥ TUI interface for LLMs written in Rust
 * [Chat2DB](https://github.com/codephiliax/chat2db) - ð¥ð¥ð¥AI-driven database tool and SQL client, The hottest GUI client, supporting MySQL, Oracle, PostgreSQL, DB2, SQL Server, DB2, SQLite, H2, ClickHouse, and more.
 * [OpenHands](https://github.com/all-hands-ai/openhands) - ð OpenHands: Code Less, Make More
 ...
 * [laravel](https://github.com/openai-php/laravel) - â¡ï¸ OpenAI PHP for Laravel is a supercharged PHP API client that allows you to interact with OpenAI API
 * [WrenAI](https://github.com/canner/wrenai) - ð Open-source SQL AI Agent for Text-to-SQL. Supporting PostgreSQL, DuckDB, MySQL, MS SQL, ClickHouse, Trino, JSON, CSV, Parquet data sources, and more! ð
 * [Queryable](https://github.com/mazzzystar/queryable) - Run OpenAI's CLIP and Apple's MobileCLIP model on iOS to search photos.
 * [ChatGPTs](https://github.com/licoy/chatgpts) - ð­ ä¸é®æ¥æä½ èªå·±çChatGPT+ä¼å¤AIç½é¡µæå¡ | One click access to your own ChatGPT+numerous AI web services
 * [ChatAny](https://github.com/licoy/chatany) - ð» ä¸é®æ¥æä½ èªå·±ç ChatGPT+ä¼å¤AI ç½é¡µæå¡ | One click access to your own ChatGPT+Many AI web services
 * [ChatAny](https://github.com/chatanyteam/chatany) - ð» ä¸é®æ¥æä½ èªå·±ç ChatGPT+ä¼å¤AI ç½é¡µæå¡ | One click access to your own ChatGPT+Many AI web services
 * [cz-git](https://github.com/zhengqbbb/cz-git) - cz-git | czg  ð ï¸ DX first and more engineered, lightweight, customizable, standard output format Commitizen adapter and CLI
 * [cherry-studio](https://github.com/kangfenmao/cherry-studio) - ð Cherry Studio is a desktop client that supports for multiple LLM providers
 * [plandex](https://github.com/plandex-ai/plandex) - AI driven development in your terminal. Designed for large, real-world tasks.
 * [PDFMathTranslate](https://github.com/byaidu/pdfmathtranslate) - PDF scientific paper translation with preserved formats - åºäº AI å®æ´ä¿çæçç PDF ææ¡£å¨æåè¯­ç¿»è¯ï¼æ¯æ Google/DeepL/Ollama/OpenAI ç­æå¡ï¼æä¾ CLI/GUI/Docker
 ...
 * [uform](https://github.com/unum-cloud/uform) - Pocket-Sized Multimodal AI for content understanding and generation across multilingual texts, images, and ð video, up to 5x faster than OpenAI CLIP and LLaVA ð¼ï¸ & ðï¸
 * [subsai](https://github.com/absadiki/subsai) - ðï¸ Subtitles generation tool (Web-UI + CLI + Python package) powered by OpenAI's Whisper and its variants ðï¸
 * [cherry-studio](https://github.com/cherryhq/cherry-studio) - ð Cherry Studio is a desktop client that supports for multiple LLM providers
 ...
 * [story-flicks](https://github.com/alecm20/story-flicks) - ä½¿ç¨AIå¤§æ¨¡åï¼ä¸é®çæé«æ¸æäºç­è§é¢ãGenerate high-definition story short videos with one click using AI large models.
 ...
 * [xiaozhi-android-client](https://github.com/tom88812/xiaozhi-android-client) - ä¸ä¸ªåºäºå°æºãxiaozhi-serverçAndroidãIOSè¯­é³å¯¹è¯åºç¨,æ¯æå®æ¶è¯­é³äº¤äºåæå­å¯¹è¯ãç°å¨æ¯flutterçæ¬ï¼æéIOSãAndroidç«¯ãè¯·åå¿ä»¬å¨å¨å°æï¼ç¹ç¹å°ææï¼äºä»¥é¼å±ã
 ...
 * [codeinterpreter-api](https://github.com/shroominic/codeinterpreter-api) - Open source implementation of the ChatGPT Code Interpreter ð¾
 ...
 * [ChatPiXiu](https://github.com/openllmai/chatpixiu) - ChatPiXiu: Docs of OpenLLMAI. Survey, reproduction and domain/task adaptation of open source chatgpt alternatives/implementations. PiXiu-è²è² means fortune.
 ...
 * [textgen](https://github.com/shibing624/textgen) - TextGen: Implementation of Text Generation models, include LLaMA, BLOOM, GPT2, BART, T5, SongNet and so on. ææ¬çææ¨¡åï¼å®ç°äºåæ¬LLaMAï¼ChatGLMï¼BLOOMï¼GPT2ï¼Seq2Seqï¼BARTï¼T5ï¼UDAç­æ¨¡åçè®­ç»åé¢æµï¼å¼ç®±å³ç¨ã
 ...
 * [T2M-GPT](https://github.com/mael-zys/t2m-gpt) - (CVPR 2023) Pytorch implementation of âT2M-GPT: Generating Human Motion from Textual Descriptions with Discrete Representationsâ
 ...
 * [chatllama](https://github.com/juncongmoo/chatllama) - ChatLLaMA ð¢ Open source implementation for LLaMA-based ChatGPT runnable in a single GPU. 15x faster training process than ChatGPT
 ...
 * [gpt4all-colab](https://github.com/camenduru/gpt4all-colab) - ð¥gpt4all (the best chatgpt clone) running locally and on colab tutorial -  -  to @camenduru's colab -
 ...
 * [bpf-developer-tutorial](https://github.com/eunomia-bpf/bpf-developer-tutorial) - Learn eBPF by examples | eBPF å¼åèæç¨ä¸ç¥è¯åºï¼éè¿å°å·¥å·åç¤ºä¾ä¸æ­¥æ­¥å­¦ä¹  eBPFï¼åå«æ§è½ãç½ç»ãå®å¨ç­å¤ç§åºç¨åºæ¯
 * [tensorflow-nlp-tutorial](https://github.com/ukairia777/tensorflow-nlp-tutorial) - tensorflowë¥¼ ì¬ì©íì¬ íì¤í¸ ì ì²ë¦¬ë¶í°, Topic Models, BERT, GPT, LLMê³¼ ê°ì ìµì  ëª¨ë¸ì ë¤ì´ì¤í¸ë¦¼ íì¤í¬ë¤ì ì ë¦¬í Deep Learning NLP ì ì¥ììëë¤.
 * [langchain-kr](https://github.com/teddylee777/langchain-kr) - LangChain ê³µì Document, Cookbook, ê·¸ ë°ì ì¤ì© ìì ë¥¼ ë°íì¼ë¡ ìì±í íêµ­ì´ íí ë¦¬ì¼ìëë¤. ë³¸ íí ë¦¬ì¼ì íµí´ LangChainì ë ì½ê³  í¨ê³¼ì ì¼ë¡ ì¬ì©íë ë°©ë²ì ë°°ì¸ ì ììµëë¤.
 ...
 * [Play-with-LLMs](https://github.com/evilpsycho/play-with-llms) - Tutorial on training, evaluating LLM, as well as utilizing RAG, Agent, Chain to build entertaining applications with LLMs.åäº«å¦ä½è®­ç»ãè¯ä¼°LLMsï¼å¦ä½åºäºRAGãAgentãChainæå»ºæè¶£çLLMsåºç¨ã
 ...
 * [ChatGLM-6B](https://github.com/thudm/chatglm-6b) - ChatGLM-6Bï¼å¼æºåè¯­å¯¹è¯è¯­è¨æ¨¡å  | An Open Bilingual Dialogue Language Model
 ...
 * [transformers](https://github.com/huggingface/transformers) - ð¤ Transformers: State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX.
 ...
 * [fib](https://github.com/r-three/fib) - are bloom, opt-175b, t0, and gpt-neox "factually consistent"? new preprint! we introduce fib - the factual inconsistency benchmark - and evaluate 23 llms. work done with @anisham197 @byryuer @mohitban47 @colinraffelð ð¾ ð§µ â¬ï¸
 * [petals](https://github.com/bigscience-workshop/petals) - ð¸ Run 100B+ language models at home, BitTorrent-style. Fine-tuning and inference up to 10x faster than offloading
 ...
 * [camel](https://github.com/lightaime/camel) - CAMEL: Communicative Agents for âMindâ Exploration of Large Scale Language Model Society
 ...
 * [ChatGPT-vs.-BERT](https://github.com/whu-zqh/chatgpt-vs.-bert) - ð[ChatGPT4NLU] A Comparative  Study on ChatGPT and Fine-tuned BERT
 * [unilm](https://github.com/microsoft/unilm) - Large-scale Self-supervised Pre-training Across Tasks, Languages, and Modalities
 * [document.ai](https://github.com/ganymedenil/document.ai) - åºäºåéæ°æ®åºä¸GPT3.5çéç¨æ¬å°ç¥è¯åºæ¹æ¡(A universal local knowledge base solution based on vector database and GPT3.5)
 ...
 * [LLMZoo](https://github.com/freedomintelligence/llmzoo) - â¡LLM Zoo is a project that provides data, models, and evaluation benchmark for large language models.â¡
 ...
 * [camel](https://github.com/lightaime/camel#data-hosted-on-hugging-face) - ð« CAMEL: Communicative Agents for âMindâ Exploration of Large Scale Language Model Society
 ...
 * [dsp](https://github.com/stanfordnlp/dsp) - ðð¦ð£: Demonstrate-Search-Predict. A framework for composing retrieval and language models for knowledge-intensive NLP.
 * [OpenAGI](https://github.com/agiresearch/openagi) - OpenAGI: When LLM Meets Domain Experts
 * [GraphGPT](https://github.com/varunshenoy/graphgpt) - Extrapolating knowledge graphs from unstructured text using GPT-3 ðµï¸ââï¸
 ...
 * [tesseract.js](https://github.com/naptha/tesseract.js) - Pure Javascript OCR for more than 100 Languages ððð¥
 ...
 * [HealthGPT](https://github.com/stanfordbdhg/healthgpt) - Query your Apple Health data with natural language ð¬ ð©º
 ...
 * [ChatPaper](https://github.com/kaixindelele/chatpaper) - Use ChatGPT to summarize the arXiv papers. å¨æµç¨å éç§ç ï¼å©ç¨chatgptè¿è¡è®ºææ»ç»+æ¶¦è²+å®¡ç¨¿+å®¡ç¨¿åå¤
 ...
 * [ALGO](https://github.com/zkx06111/algo) - ðIntroducing ALGO, a code synthesis framework guided by LLM-generated oracles. Integrated with ALGO, Codex is 8x better and ChatGPT 1.3x better at contest-level problems. Plus, ALGO verifies your solution before submission!ð§µð:ð:
 ...
 * [lamini](https://github.com/lamini-ai/lamini) - Today:ðHosted data generator for training LLMs like ChatGPT ðAn open-source LLM, trained on the generated data with the Lamini engine ðEarly access waitlist to full training, incl. enterprise VPC etc.
 ...
 * [MetaGPT](https://github.com/geekan/metagpt) - The Multi-Agent Meta Programming Framework: Given one line Requirement, return PRD, Design, Tasks, Repo | å¤æºè½ä½åç¼ç¨æ¡æ¶ï¼ç»å®èæ¿éæ±ï¼è¾åºäº§åææ¡£ãæ¶æè®¾è®¡ãä»»å¡åè¡¨ãä»£ç 
 ...
 * [SuperAGI](https://github.com/transformeroptimus/superagi) - <â¡ï¸> SuperAGI - A dev-first open source autonomous AI agent framework. Enabling developers to build, manage & run useful autonomous agents quickly and reliably.
 ...
 * [AiNiee-chatgpt](https://github.com/nekoparapa/ainiee-chatgpt) - ä¸æ¬¾åºäºãmtoolãæãTranslator++ãï¼chatgptèªå¨æ¹éç¿»è¯å·¥å·ï¼ä¸»è¦æ¯ç¨æ¥ç¿»è¯åç§RPGæ¸¸æã
 * [openai-forward](https://github.com/beidongjiedeguang/openai-forward) - ð ä¸ä¸ªä¸ä¸ºå¤§åè¯­è¨æ¨¡åè®¾è®¡çè½¬åæå¡ Â·  ä¸é®é¨ç½²ä½ çç§äººAIä»£ç Â· LLM Proxy Â· OpenAI API Reverse Proxy
 ...
 * [SiriGPT](https://github.com/nicolodiamante/sirigpt) - Unleash the power of SiriGPT: the intersection of ChatGPTâs intelligence, DALLÂ·E's creativity, and Whisper's precise audio transcription for your Apple devices with support of 20 languages.
 * [chie](https://github.com/chieapp/chie) - An extensive desktop app for ChatGPT and other LLMs.
 * [chatnio](https://github.com/zmh-program/chatnio) - ð document of Zh-Website project (using vitepress)
 ...
 * [LLMforDialogDataGenerate](https://github.com/threecolorfr/llmfordialogdatagenerate) - Generate dialog data from documents using LLM like ChatGLM2 or ChatGPT;å©ç¨ChatGLM2,ChatGPTç­å¤§æ¨¡åæ ¹æ®ææ¡£çæå¯¹è¯æ°æ®é
 * [Auto-i18n](https://github.com/linyuxuanlin/auto-i18n) - ä½¿ç¨ ChatGPT èªå¨å° Markdown æä»¶æ¹éç¿»è¯ä¸ºå¤è¯­è¨ | Auto translate Markdown files to multi languages using ChatGPT
 ...
 * [one-api](https://github.com/songquanpeng/one-api) - OpenAI æ¥å£ç®¡ç & ååç³»ç»ï¼æ¯æ AzureãAnthropic ClaudeãGoogle PaLM 2ãæºè°± ChatGLMãç¾åº¦æå¿ä¸è¨ãè®¯é£æç«è®¤ç¥ãé¿ééä¹åé®ã360 æºèä»¥åè¾è®¯æ··åï¼å¯ç¨äºäºæ¬¡ååç®¡ç keyï¼ä»åå¯æ§è¡æä»¶ï¼å·²æåå¥½ Docker éåï¼ä¸é®é¨ç½²ï¼å¼ç®±å³ç¨. OpenAI key management & redistribution system, using a single API for all LLMs, and features an English UI.
 ...
 * [Otter](https://github.com/luodian/otter) - ð¦¦ Otter, a multi-modal model based on OpenFlamingo (open-sourced version of DeepMind's Flamingo), trained on MIMIC-IT and showcasing improved instruction-following and in-context learning ability.
 ...
 * [MNBVC](https://github.com/esbatmop/mnbvc) - MNBVC(Massive Never-ending BT Vast Chinese corpus)è¶å¤§è§æ¨¡ä¸­æè¯­æéãå¯¹æ chatGPTè®­ç»ç40Tæ°æ®ãMNBVCæ°æ®éä¸ä½åæ¬ä¸»æµæåï¼ä¹åæ¬åä¸ªå°ä¼æåçè³ç«ææçæ°æ®ãMNBVCæ°æ®éåæ¬æ°é»ãä½æãå°è¯´ãä¹¦ç±ãæå¿ãè®ºæãå°è¯ãå¸å­ãwikiãå¤è¯ãæ­è¯ãååä»ç»ãç¬è¯ãç³äºãèå¤©è®°å½ç­ä¸åå½¢å¼ççº¯ææ¬ä¸­ææ°æ®ã
 * [Easydict](https://github.com/tisfeng/easydict) - ä¸ä¸ªç®æ´ä¼éçè¯å¸ç¿»è¯ macOS Appãå¼ç®±å³ç¨ï¼æ¯æç¦»çº¿ OCR è¯å«ï¼æ¯ææéè¯å¸ï¼ð è¹æç³»ç»è¯å¸ï¼ð è¹æç³»ç»ç¿»è¯ï¼ChatGPTï¼DeepLï¼Googleï¼Bingï¼ç¾åº¦åç«å±±ç¿»è¯ãA concise and elegant Dictionary and Translator macOS App for looking up words and translating text.
 ...
 * [aidea-server](https://github.com/mylxsw/aidea-server) - AIdea æ¯ä¸æ¬¾æ¯æ GPT  ä»¥åå½äº§å¤§è¯­è¨æ¨¡åéä¹åé®ãæå¿ä¸è¨ç­ï¼æ¯æ Stable Diffusion æçå¾ãå¾çå¾ã SDXL1.0ãè¶åè¾¨çãå¾çä¸è²çå¨è½å APPã
 ...
 * [openai-forward](https://github.com/kenyony/openai-forward) - ð  å¤§è¯­è¨æ¨¡åé«æè½¬åæå¡  Â· An efficient forwarding service designed for LLMs. Â·  OpenAI API Reverse Proxy
 ...
 * [llm-paper-daily](https://github.com/xianshang33/llm-paper-daily) - Daily updated LLM papers.        æ¯æ¥æ´æ° LLM ç¸å³çè®ºæï¼æ¬¢è¿è®¢é ð   åæ¬¢çè¯å¨å¨ä½ çå°æ ð ä¸ä¸ª
 ...
 * [StreamRAG](https://github.com/video-db/streamrag) - Video Search and Streaming Agent ðµï¸ââï¸
 ...
 * [visual-openllm](https://github.com/visual-openllm/visual-openllm) - something like visual-chatgpt, æå¿ä¸è¨çå¼æºç
 ...
 * [agency](https://github.com/neurocult/agency) - ðµï¸ââï¸ Library designed for developers eager to explore the potential of Large Language Models (LLMs) and other generative AI through a clean, effective, and Go-idiomatic approach.
 * [subtitle-translator-electron](https://github.com/gnehs/subtitle-translator-electron) - âï¸ Translate subtitle using ChatGPT
 * [obsidian-ava](https://github.com/different-ai/obsidian-ava) - Quickly format your notes with ChatGPT in Obsidian
 * [spacy-transformers](https://github.com/explosion/spacy-transformers) - ð¸ Use pretrained transformers like BERT, XLNet and GPT-2 in spaCy
 ...
 * [InternVL](https://github.com/opengvlab/internvl) - [CVPR 2024 Oral] InternVL Family: A Pioneering Open-Source Alternative to GPT-4V.  æ¥è¿GPT-4Vè¡¨ç°çå¯åç¨å¼æºæ¨¡å
 * [GPTSwarm](https://github.com/metauto-ai/gptswarm) - ð GPTSwarm: LLM agents as (Optimizable) Graphs
 * [nixtla](https://github.com/nixtla/nixtla) - TimeGPT-1: production ready pre-trained Time Series Foundation Model  for forecasting and anomaly detection. Generative pretrained transformer for time series trained on over 100B data points. It's capable of accurately predicting various domains such as retail, electricity, finance, and IoT with just a few lines of code ð.
 ...
 * [BetterOCR](https://github.com/junhoyeo/betterocr) - ð Better text detection by combining multiple OCR engines (EasyOCR, Tesseract, and Pororo) with ð§  LLM.
 ...
 * [auto-novel](https://github.com/fishhawk/auto-novel) - è½»å°è¯´æºç¿»ç½ç«ï¼æ¯æç½ç»å°è¯´/æåºå°è¯´/æ¬å°å°è¯´
 * [Q-Bench](https://github.com/q-future/q-bench) - â [ICLR2024 Spotlight] (GPT-4V/Gemini-Pro/Qwen-VL-Plus+16 OS MLLMs) A benchmark for multi-modality LLMs (MLLMs) on low-level vision and visual quality assessment.
 ...
 * [Github-Ranking-AI](https://github.com/yuxiaopeng/github-ranking-ai) - A list of the most popular AI Topic repositories on GitHub based on the number of stars they have received.| AIç¸å³ä¸»é¢Githubä»åºæåï¼æ¯æ¥èªå¨æ´æ°ã
 ...
 * [AlignBench](https://github.com/thudm/alignbench) - å¤§æ¨¡åå¤ç»´åº¦ä¸­æå¯¹é½è¯æµåºå (ACL 2024)
 ...
 * [MiniCPM](https://github.com/openbmb/minicpm) - MiniCPM3-4Bï¼An edge-side LLM that surpasses GPT-3.5-Turbo.
 ...
 * [MaxKB](https://github.com/1panel-dev/maxkb) - ð åºäºå¤§è¯­è¨æ¨¡åå RAG çç¥è¯åºé®ç­ç³»ç»ãå¼ç®±å³ç¨ãæ¨¡åä¸­ç«ãçµæ´»ç¼æï¼æ¯æå¿«éåµå¥å°ç¬¬ä¸æ¹ä¸å¡ç³»ç»ã
 ...
 * [TEN-Agent](https://github.com/ten-framework/ten-agent) - TEN Agent is the worldâs first real-time multimodal agent integrated with the OpenAI Realtime API, RTC, and features weather checks, web search, vision, and RAG capabilities.
 ...
 * [BricksLLM](https://github.com/bricks-cloud/bricksllm) - ð Enterprise-grade API gateway that helps you monitor and impose cost or rate limits per API key. Get fine-grained access control and monitoring per user, application, or environment. Supports OpenAI, Azure OpenAI, Anthropic, vLLM, and open-source LLMs.
 ...
 * [bailing](https://github.com/wwbin2017/bailing) - ç¾è æ¯ä¸ä¸ªç±»ä¼¼GPT-4oçè¯­é³å¯¹è¯æºå¨äººï¼éè¿ASR+LLM+TTSå®ç°ï¼éæDeepSeek R1ç­ä¼ç§å¤§æ¨¡åï¼æ¶å»¶ä½è³800msï¼ä½éç½®ä¹å¯è¿è¡ï¼æ¯æææ­
 * [brainrot.js](https://github.com/brainrotjs/brainrot.js) - Text to video generator in the brainrot form. Learn about any topic from your favorite personalities ð¼.
 * [AIaW](https://github.com/nitrorcr/aiaw) - AI as Workspace - ç²¾å¿è®¾è®¡ç AI (LLM) å®¢æ·ç«¯ã å¨åè½ï¼è½»éçº§ï¼æ¯æå¤å·¥ä½åºãæä»¶ç³»ç»ãè·¨å¹³å°ãæ¬å°ä¼å+å®æ¶äºåæ­¥ãArtifacts
 * [uni-api](https://github.com/yym68686/uni-api) - This is a project that unifies the management of LLM APIs. It can call multiple backend services through a unified API interface, convert them to the OpenAI format uniformly, and support load balancing. Currently supported backend services include: OpenAI, AI/ML API, Anthropic, DeepBricks, OpenRouter, Gemini, Vertex, etc.
 ...
 * [ruby_llm](https://github.com/crmne/ruby_llm) - A delightful Ruby way to work with AI. No configuration madness, no complex callbacks, no handler hell â just beautiful, expressive Ruby code.
 ...
 * [hcaptcha-challenger](https://github.com/qin2dim/hcaptcha-challenger) - ð¥ Gracefully face hCaptcha challenge with multimodal large language model.
 * [new-api](https://github.com/quantumnous/new-api) - AIæ¨¡åæ¥å£ç®¡çä¸ååç³»ç»ï¼æ¯æå°å¤ç§å¤§æ¨¡åè½¬ä¸ºç»ä¸æ ¼å¼è°ç¨ï¼æ¯æOpenAIãClaudeç­æ ¼å¼ï¼å¯ä¾ä¸ªäººæèä¼ä¸åé¨ç®¡çä¸ååæ¸ éä½¿ç¨ï¼æ¬é¡¹ç®åºäºOne APIäºæ¬¡å¼åãð¥ The next-generation LLM gateway and AI asset management system supports multiple languages.
 * [deep-research](https://github.com/u14app/deep-research) - Use any LLMs (Large Language Models) for Deep Research.
 * [EmbedAnything](https://github.com/starlightsearch/embedanything) - Production-ready Inference, Ingestion and Indexing built in Rust ð¦
 ...
 * [Rankify](https://github.com/datascienceuibk/rankify) - ð¥ Rankify: A Comprehensive Python Toolkit for Retrieval, Re-Ranking, and Retrieval-Augmented Generation ð¥. Our toolkit integrates 40 pre-retrieved benchmark datasets and supports 7+ retrieval techniques, 24+ state-of-the-art Reranking models, and multiple RAG methods.
 * [auto-novel](https://github.com/auto-novel/auto-novel) - è½»å°è¯´æºç¿»ç½ç«ï¼æ¯æç½ç»å°è¯´/æåºå°è¯´/æ¬å°å°è¯´
 ...
 * [AI-Codereview-Gitlab](https://github.com/sunmh207/ai-codereview-gitlab) - åºäºå¤§æ¨¡å(DeepSeek,OpenAIç­)ç GitLab èªå¨ä»£ç å®¡æ¥å·¥å·ï¼æ¯æéé/ä¼ä¸å¾®ä¿¡/é£ä¹¦æ¨éæ¶æ¯åçææ¥æ¥ï¼æ¯æDockeré¨ç½²ï¼å¯è§å Dashboardã
 ...
 * [ai-llm-comparison](https://github.com/ahmet-dedeler/ai-llm-comparison) - A website where you can compare every AI Model â¨
 ...
 * [langchain](https://github.com/hwchase17/langchain) - â¡ Building applications with LLMs through composability â¡
 ...
 * [open_llama](https://github.com/openlm-research/open_llama) - OpenLLama - a permissively licensed open source reproduction of Meta AI's LLaMA. ð¦ âOpenLLaMA exhibits comparable performance to the original LLaMA and GPT-J across a majority of tasks, and outperforms them in some tasks.â ð
 ...
 * [LaWGPT](https://github.com/pengxiao-song/lawgpt) - ð Repo for LaWGPT, Chinese-Llama tuned with Chinese Legal knowledge. åºäºä¸­ææ³å¾ç¥è¯çå¤§è¯­è¨æ¨¡å
 ...
 * [chainlit](https://github.com/chainlit/chainlit) - Build Python LLM apps in minutes â¡ï¸
 ...
 * [MedicalGPT](https://github.com/shibing624/medicalgpt) - MedicalGPT: Training Your Own Medical GPT Model with ChatGPT Training Pipeline. è®­ç»å»çå¤§æ¨¡åï¼å®ç°åæ¬äºæ¬¡é¢è®­ç»ãæçç£å¾®è°ãå¥å±å»ºæ¨¡ãå¼ºåå­¦ä¹ è®­ç»ã
 * [rag-stack](https://github.com/psychic-api/rag-stack) - ð¤ Deploy a private ChatGPT alternative hosted within your VPC. ð® Connect it to your organization's knowledge base and use it as a corporate oracle. Supports open-source LLMs like Llama 2, Falcon, and GPT4All.
 ...
 * [api-for-open-llm](https://github.com/xusenlinzy/api-for-open-llm) - openai style api for open large language models, using LLMs just as chatgpt! å¼æºå¤§æ¨¡åçç»ä¸åç«¯æ¥å£
 ...
 * [BayLing](https://github.com/ictnlp/bayling) - âç¾èâæ¯ä¸ä¸ªåºäºLLaMAçè¯­è¨å¯¹é½å¢å¼ºçè±è¯­/ä¸­æå¤§è¯­è¨æ¨¡åï¼å·æä¼è¶çè±è¯­/ä¸­æè½åï¼å¨å¤è¯­è¨åéç¨ä»»å¡ç­å¤é¡¹æµè¯ä¸­åå¾ChatGPT 90%çæ§è½ãBayLing is an English/Chinese LLM equipped with advanced language alignment, showing superior capability in English/Chinese generation, instruction following and multi-turn interaction.
 ...
 * [FindTheChatGPTer](https://github.com/chenking2020/findthechatgpter) - ChatGPTçç«ï¼å¼å¯äºéå¾AGIçå³é®ä¸æ­¥ï¼æ¬é¡¹ç®æ¨å¨æ±æ»é£äºChatGPTçå¼æºå¹³æ¿ä»¬ï¼åæ¬ææ¬å¤§æ¨¡åãå¤æ¨¡æå¤§æ¨¡åç­ï¼ä¸ºå¤§å®¶æä¾ä¸äºä¾¿å©
 * [gpt_academic](https://github.com/binary-husky/gpt_academic) - ä¸ºChatGPT/GLMæä¾å®ç¨åäº¤äºçé¢ï¼ç¹å«ä¼åè®ºæéè¯»/æ¶¦è²/åä½ä½éªï¼æ¨¡ååè®¾è®¡ï¼æ¯æèªå®ä¹å¿«æ·æé®&å½æ°æä»¶ï¼æ¯æPythonåC++ç­é¡¹ç®åæ&èªè¯è§£åè½ï¼PDF/LaTexè®ºæç¿»è¯&æ»ç»åè½ï¼æ¯æå¹¶è¡é®è¯¢å¤ç§LLMæ¨¡åï¼æ¯æchatglm2ç­æ¬å°æ¨¡åãå¼å®¹æå¿ä¸è¨, moss, llama2, rwkv, claude2, éä¹åé®, ä¹¦ç, è®¯é£æç«ç­ã
 ...
 * [Alpaca-CoT](https://github.com/phoebussi/alpaca-cot) - We unified the interfaces of instruction-tuning data (e.g., CoT data), multiple LLMs and parameter-efficient methods (e.g., lora, p-tuning) together for easy use. We welcome open-source enthusiasts to initiate any meaningful PR on this repo and integrate as many LLM related technologies as possible. æä»¬æé äºæ¹ä¾¿ç ç©¶äººåä¸æåä½¿ç¨å¤§æ¨¡åç­å¾®è°å¹³å°ï¼æä»¬æ¬¢è¿å¼æºç±å¥½èåèµ·ä»»ä½ææä¹çprï¼
 ...
 * [code-review-gpt](https://github.com/mattzcarey/code-review-gpt) - Your personal code reviewer powered by LLMs (OpenAI GPT-3.5/4, Llama2, Azure AI) & Embeddings â¡ï¸ Improve code quality and catch bugs before you break production ð
 ...
 * [kani](https://github.com/zhudotexe/kani) - kani (ã«ã) is a highly hackable microframework for chat-based language models with tool use/function calling. (NLP-OSS @ EMNLP 2023)
 ...
 * [CareGPT](https://github.com/wangrongsheng/caregpt) - ð CareGPT (å³æGPT)æ¯ä¸ä¸ªå»çå¤§è¯­è¨æ¨¡åï¼åæ¶å®éåäºæ°åä¸ªå¬å¼å¯ç¨çå»çå¾®è°æ°æ®éåå¼æ¾å¯ç¨çå»çå¤§è¯­è¨æ¨¡åï¼åå«LLMçè®­ç»ãæµè¯ãé¨ç½²ç­ä»¥ä¿è¿å»çLLMå¿«éåå±ãMedical LLM, Open Source Driven for a Healthy Future.
 ...
 * [langflow](https://github.com/langflow-ai/langflow) - âï¸ Langflow is a dynamic graph where each node is an executable unit. Its modular and interactive design fosters rapid experimentation and prototyping, pushing hard on the limits of creativity.
 * [ChatLLM](https://github.com/yuanjie-ai/chatllm) - è½»æ¾ç©è½¬LLMå¼å®¹openai&langchainï¼æ¯ææå¿ä¸è¨ãè®¯é£æç«ãè¾è®¯æ··åãæºè°±ChatGLMç­
 * [MiniCPM-V](https://github.com/openbmb/minicpm-v) - MiniCPM-Llama3-V 2.5: A GPT-4V Level MLLM on Your Phone
 * [LLamaTuner](https://github.com/jianzhnie/llamatuner) - Easy and Efficient Finetuning  LLMs. (Supported LLama, LLama2, LLama3, Qwen,  Baichuan, GLM , Falcon) å¤§æ¨¡åé«æéåè®­ç»+é¨ç½².
 * [langtorch](https://github.com/li2109/langtorch) - ð¥ Building composable LLM applications & workflow with Java.
 * [dialog](https://github.com/talkdai/dialog) - RAG LLM Ops App for easy deployment and testing
 * [aikit](https://github.com/sozercan/aikit) - ðï¸ Fine-tune, build, and deploy open-source LLMs easily!
 * [llm-ui](https://github.com/llm-ui-kit/llm-ui) - The React library for LLMs
 * [search_with_ai](https://github.com/yokingma/search_with_ai) - ð¤ Free Search with AI, ð¡ Open-Source Perplexity, ð Support Ollama/SearXNG, Support Docker deployment.  è®©AIå¤§æ¨¡ååæç´¢å¼æåç­ä½ çé®é¢ï¼æ¯ææ¬å°å¤§æ¨¡å(Ollama)ãèåæç´¢å¼æSearXNGï¼æ¯æDockerä¸é®é¨ç½²ã
 ...
 * [langchain-swift](https://github.com/buhe/langchain-swift) - ð LangChain for Swift. Optimized for iOS, macOS, watchOS (part) and visionOS.(beta)
 ...
 * [QiZhenGPT](https://github.com/cmkrg/qizhengpt) - QiZhenGPT: An Open Source Chinese Medical Large Language Modelï½ä¸ä¸ªå¼æºçä¸­æå»çå¤§è¯­è¨æ¨¡å
 ...
 * [MLE-agent](https://github.com/mlsysops/mle-agent) - ð¤ MLE-Agent: Your intelligent companion for seamless AI engineering and research. ð Integrate with arxiv and paper with code to provide better code/research plans ð§° OpenAI, Anthropic, Ollama, etc supported. :fireworks: Code RAG
 ...
 * [tensorzero](https://github.com/tensorzero/tensorzero) - TensorZero creates a feedback loop for optimizing LLM applications â turning production data into smarter, faster, and cheaper models.
 * [langchain-rust](https://github.com/abraxas-365/langchain-rust) - ð¦ï¸ðLangChain for Rust, the easiest way to write LLM-based programs in Rust
 ...
 * [langchat](https://github.com/tycoding/langchat) - LangChat: Java LLMs/AI Project, Supports Multi AI Providers( Gitee AI/ æºè°±æ¸è¨ / é¿ééä¹ / ç¾åº¦åå¸ / DeepSeek / æé³è±å / é¶ä¸ä¸ç© / è®¯é£æç« / OpenAI / Gemini / Ollama / Azure / Claude ç­å¤§æ¨¡å), Javaçæä¸AIå¤§æ¨¡åäº§åè§£å³æ¹æ¡ï¼å¿«éæå»ºä¼ä¸çº§AIç¥è¯åºãAIæºå¨äººåºç¨
 ...
 * [video-subtitle-master](https://github.com/buxuku/video-subtitle-master) - æ¹éä¸ºè§é¢æèé³é¢çæå­å¹ï¼å¹¶å¯æ¹éå°å­å¹ç¿»è¯æå¶å®è¯­è¨ãè¿æ¯ä¸ä¸ªå®¢æ·ç«¯å·¥å·, è·¨å¹³å°æ¯æ mac å windows ç³»ç», æ¯æç¾åº¦ï¼ç«å±±ï¼deeplx, openai, deepseek, ollama ç­å¤ä¸ªç¿»è¯æå¡
 ...
 * [Yuxi-Know](https://github.com/xerrors/yuxi-know) - åºäºå¤§æ¨¡å RAG ç¥è¯åºçç¥è¯å¾è°±é®ç­ç³»ç»ãLlamaindex + VueJS + Flask + Neo4jãå¤§æ¨¡åéé OpenAIãå½åä¸»æµå¤§æ¨¡åå¹³å°çæ¨¡åè°ç¨ãæ¬å° vllm é¨ç½²ãæ¯ææ¨çæ¨¡åDeepSeek-R1ãèç½æ£ç´¢ã
 * [SmartSub](https://github.com/buxuku/smartsub) - ãå¦å¹ãæ¯ä¸æ¬¾è·¨å¹³å°å®¢æ·ç«¯å·¥å·ï¼å¯ä»¥æ¹éä¸ºè§é¢æèé³é¢çæå­å¹æä»¶ï¼å¹¶æ¯æå¯¹å­å¹è¿è¡ç¿»è¯ï¼æ¯æç¾åº¦ãç«å±±ãopenaiãollamaãdeepseek ç­å¤å®¶ç¿»è¯
 * [minuet-ai.nvim](https://github.com/milanglacier/minuet-ai.nvim) - ð Dance with Intelligence in Your Code. Minuet offers code completion as-you-type from popular LLMs including OpenAI, Gemini, Claude, Ollama, Llama.cpp, Codestral, and more.
 ...
 * [helix](https://github.com/helixml/helix) - â¾ï¸ Helix is a private GenAI stack for building AI applications with declarative pipelines, knowledge (RAG), API bindings, and first-class testing.
 * [openinference](https://github.com/arize-ai/openinference) - OpenTelemetry Instrumentation for AI Observability
 * [WorkflowAI](https://github.com/workflowai/workflowai) - WorkflowAI is an open-source platform where product and engineering teams â¨collaborate to build and iterate on AI features.
 ...
 * [unity-AI-Chat-Toolkit](https://github.com/zhangliwei7758/unity-ai-chat-toolkit) - ä½¿ç¨unityå®ç°AIèå¤©ç¸å³åè½ãç®åè¿ä¸ªåºåå«äºå¯¹chatgptãchatglmç­å¤§è¯­è¨æ¨¡åçapiè°ç¨çä»£ç å®ç°ä»¥åå®ç°äºå¾®è½¯Azureä»¥åç¾åº¦AIçè¯­é³æå¡åè½ï¼è¯­é³æå¡åéç¨web apiå®ç°ï¼æ¯æWindows/WebGL/Androidç­å¹³å°
 ...
 * [OpenChatKit](https://github.com/togethercomputer/openchatkit) - #openchatkit is the first #opensource alternative to #chatgpt! ð¤¯it's a 20b param. model built by ex-@openai folks (@togethercompute) and fine-tuned using @aieleuther's gpt-neox-20b!ð demo: ð gh: ð½ï¸ video: @itakgol â
 ...
 * [scrapeghost](https://github.com/jamesturk/scrapeghost) - ð» Experimental library for scraping websites using OpenAI's GPT API.
 ...
 * [disco-diffusion](https://github.com/alembics/disco-diffusion) - openaiå¼åçaiæ¨¡åç®åæ¯è¾ç¥åçæï¼ #chatgptã#midjourneyã#stablediffusionchat ä»å¤©ä¸ºå¤§å®¶æ´æ°5ä¸ªå¥½ç¨çaiç®æ³æ¨¡åå­¦ä¹ æ¸ é1ãç¥åä¸­æaiç®æ³å¸åº:ãdisco-diffusionå:ãç¾åº¦æå¿ ernie-vilg:
 ...
 * [userscripts](https://github.com/adamlui/userscripts) - ðµ MTurk, ChatGPT and other Greasemonkey userscripts.
 ...
 * [cloudflare-proxy](https://github.com/barretlee/cloudflare-proxy) - Cloudflare Worker ä»£çè¯·æ± ChatGPT APIï¼æ¯æ Stream æµå¼è¾åº
 ...
 * [ChatGPT](https://github.com/lencx/chatgpt) - ð® ChatGPT Desktop Application (Mac, Windows and Linux)
 ...
 * [ruby-openai](https://github.com/alexrudall/ruby-openai) - OpenAI API + Ruby! ð¤â¤ï¸ Now with ChatGPT and Whisper...
 ...
 * [carrot](https://github.com/xx025/carrot) - Free ChatGPT Site List è¿å¿ä¸ºä½ åå¤äºä¼å¤åè´¹å¥½ç¨çChatGPTéåç«ç¹ï¼å½å100+ç«ç¹
 ...
 * [polyglot](https://github.com/liou666/polyglot) - ð¤ï¸ æ¡é¢ç«¯AIè¯­è¨ç»ä¹ åºç¨
 ...
 * [ai-beehive](https://github.com/hncboy/ai-beehive) - AI èå·¢ï¼åºäº Java ä½¿ç¨ Spring Boot 3 å JDK 17ï¼æ¯æçåè½æ ChatGPTãOpenAi ImageãMidjourneyãNewBing ç­ç­
 * [cloudflare-reverse-proxy](https://github.com/gaboolic/cloudflare-reverse-proxy) - cloudflareååä»£ç|OpenAI/ChatGPT åç¿»å¢ä»£ç|githubåç¿»å¢ä»£ç|githubä¸è½½å é|googleä»£ç|cloudflareä¸è½ä»£ç
 ...
 * [springboot-openai-chatgpt](https://github.com/274056675/springboot-openai-chatgpt) - è¶çº§AIå¤§èä¸ä¸ªåºäºSpring Bootæ¶æï¼æ¯æwebï¼Androidï¼IOSï¼H5å¤ç«¯åºç¨ï¼ä½¿ç¨äºOpenAIçChatGPTæ¨¡åå®ç°äºæºè½èå¤©æºå¨äººãç¨æ·å¯ä»¥å¨çé¢ä¸ä¸èå¤©æºå¨äººè¿è¡å¯¹è¯ï¼èå¤©æºå¨äººä¼æ ¹æ®ç¨æ·çè¾å¥èªå¨çæåå¤ãåæ¶ä¹æ¯æç»å¾ï¼ç¨æ·è¾å¥ææ¬ï¼ä¾¿å¯ä»¥èªå¨å¶ä½æçæçå¾ãæªæ¥ä¼æ¥å¥ï¼æå¿ä¸è¨ãéä¹åé®ãMOSSç­å½äº§AIå¤§æ¨¡åï¼æç»­æ´æ°ä¸­ï¼æ´å¤åè½ç­çä½ æ¥è§£é
 * [chatgpt-quickstart](https://github.com/azure-samples/chatgpt-quickstart) - Build a chat application using Azure OpenAI with ChatGPT.
 ...
 * [openai-billing-query](https://github.com/woodchen-ink/openai-billing-query) - åé¡µé¢é¡¹ç®ï¼æ¹éå¯è§åæ¥è¯¢openai(chatgpt)ä½é¢ï¼æ¯ææ¾ç¤ºæ»éï¼å·²ä½¿ç¨ï¼å©ä½éï¼å·²ç¨æ¯ä¾ï¼å°ææ¶é´ï¼GPT-4ï¼æ¯å¦ç»å¡ãThis is a single-page project that enables batch visualization query for openai (chatgpt) balance. It supports displaying total amount, used amount, remaining amount, usage ratio, expiration time, GPT-4, and whether it is bound with a card.
 ...
 * [Vontigo](https://github.com/vontigo/vontigo) - ð¸ Vontigo is an open-source CMS built with SvelteKit, featuring ð¤ AI-powered (ChatGPT) content generation. With fast page loads and seamless routing, Vontigo offers a user-friendly interface with customizable themes and templates.
 ...
 * [chat](https://github.com/libli/chat) - æç¨æ·ç®¡çåè½çChatGPT APIéæä»£çåå°
 * [chatgpt-nodejs-web](https://github.com/xingxin666/chatgpt-nodejs-web) - chatgpt nodejsæå¡ï¼éæäºChatGLMãGPT3.5ãGPT4ãGPTèç½ãå¿åºãClaudeãç¾åº¦æå¿ä¸è¨ç­æ¨¡å
 ...
 * [chatgpt-ai-template](https://github.com/horizon-ui/chatgpt-ai-template) - ð§  Horizon AI Template - Trendiest Open-source ChatGPT UI AI Template & Starter Kit for React, NextJS & Chakra UI
 ...
 * [Free-ChatGPT-API](https://github.com/mufeng510/free-chatgpt-api) - åºäºpandoraçChatGPT APIï¼å®ç°äºpool tokençèªå¨æ´æ°
 ...
 * [Dingtalk-OpenAI](https://github.com/connectai-e/dingtalk-openai) - ð éé & ð¤ GPT-3.5 è®©ä½ çå·¥ä½æçç´æ¥èµ·é£ ð ç§èç¾¤èæ¹å¼ãåèä¸²èæ¨¡å¼ãè§è²æ®æ¼ãå¾çåä½ ð
 ...
 * [ChatGPT_JCM](https://github.com/202252197/chatgpt_jcm) - OpenAIç®¡ççé¢ï¼èåäºOpenAIçæææ¥å£è¿è¡çé¢æä½(æææ¨¡åãå¾çãé³é¢ãå¾®è°ãæä»¶)ç­ï¼æ¯æMarkdownæ ¼å¼(å¬å¼ãå¾è¡¨ï¼è¡¨æ ¼)ç­ï¼åæä¼ä¸ç¹ä¸ç¹çå°OpenAIæ¥å£è¿è¡æ¥å¥å¤§å®¶æ¯æä¸ä¸ï¼å³ä¸è§ç¹ä¸ªStarï¼æä¼ä¸ç´æ´æ°ä¸å»ï¼å¤§å®¶ä¸èµ·å­¦ä¹ ï¼ä¸èµ·å æ²¹ï¼ä¸èµ·åªåï¼ä¸èµ·æé¿ã
 ...
 * [chatgpt-web](https://github.com/chatgpt-web-dev/chatgpt-web) - ç¨ Express å  Vue3 æ­å»ºç ChatGPT  æ­¤é¡¹ç® Fork èª  Chanzhaoyu/chatgpt-web æ°å¢äºå¤ç§æ·ç®¡çä»¥åäºç«¯æ¶æ¯åæ­¥åè½  åºäº MIT åè®®ï¼åè´¹ä¸ä½ä¸ºå¼æºå­¦ä¹ ä½¿ç¨
 ...
 * [finance](https://github.com/saleem-hadad/finance) - ð° Free open-source personal finance tracking web application powered by ChatGPT.
 * [chatgpt-web](https://github.com/xqdoo00o/chatgpt-web) - Pure Javascript ChatGPT demo based on OpenAI API
 * [one-api](https://github.com/martialbe/one-api) - OpenAI æ¥å£ç®¡ç & ååç³»ç»ï¼æ¹èªsongquanpeng/one-apiãæ¯ææ´å¤æ¨¡åï¼å å¥ç»è®¡é¡µé¢ï¼å®åéopenaiæ¨¡åçå½æ°è°ç¨ã
 ...
 * [yomo](https://github.com/yomorun/yomo) - ð¦ Stateful Serverless Framework for building Geo-distributed Edge AI Infra
 ...
 * [hisabi](https://github.com/hisabi-app/hisabi) - ð° Free open-source personal finance tracking web application powered by ChatGPT.
 ...
 * [generative-manim](https://github.com/360macky/generative-manim) - ð¨ GPT for video generation â¡ï¸
 ...
 * [ai-commit](https://github.com/guanguans/ai-commit) - Automagically generate conventional git commit messages with AI. - ä½¿ç¨ AI èªå¨çæçº¦å®å¼ git æäº¤ä¿¡æ¯ã
 * [MatGPT](https://github.com/toshiakit/matgpt) - MATLAB app to access ChatGPT API from OpenAI
 * [one-hub](https://github.com/martialbe/one-hub) - OpenAI æ¥å£ç®¡ç & ååç³»ç»ï¼æ¹èªsongquanpeng/one-apiãæ¯ææ´å¤æ¨¡åï¼å å¥ç»è®¡é¡µé¢ï¼å®åéopenaiæ¨¡åçå½æ°è°ç¨ã
 ...
 * [PureChat](https://github.com/hyk260/purechat) - PureChat æ¯ä¸ä¸ªéæ ChatGPT çèå¤©åºç¨ï¼åºäº Vue3 ï¼Vite5ï¼Electronå¼å
 ...
 * [ToolJet](https://github.com/tooljet/tooljet) - Low-code platform for building business applications. Connect to databases, cloud storages, GraphQL, API endpoints, Airtable, Google sheets, OpenAI, etc and build apps using drag and drop application builder. Built using JavaScript/TypeScript. ð
 ...
 * [pr-agent](https://github.com/codium-ai/pr-agent) - ðCodiumAI PR-Agent: An AI-Powered ð¤ Tool for Automated Pull Request Analysis, Feedback, Suggestions and More! ð»ð
 ...
 * [DashPlayer](https://github.com/solidspoon/dashplayer) - ä¸ºè±è¯­å­¦ä¹ èéèº«æé çè§é¢æ­æ¾å¨ï¼å©ä½ éè¿è§çè§é¢ãæ²æµ¸çå®è¯­å¢ï¼è½»æ¾æåè±è¯­æ°´å¹³ã#ç¾å§ #æ­æ¾å¨ #å¬å
 * [logfire](https://github.com/pydantic/logfire) - Uncomplicated Observability for Python and beyond! ðªµð¥
 ...
 * [STranslate](https://github.com/zggsong/stranslate) - A ready-to-use, ready-to-go translation ocr tool developed by WPF/WPF å¼åçä¸æ¬¾å³å¼å³ç¨ãå³ç¨å³èµ°çç¿»è¯ãOCRå·¥å·
 ...
 * [simple-one-api](https://github.com/fruitbars/simple-one-api) - OpenAI æ¥å£æ¥å¥ééï¼æ¯æåå¸å¤§æ¨¡åå¹³å°ãè®¯é£æç«å¤§æ¨¡åãè¾è®¯æ··åä»¥åMiniMaxãDeep-Seekï¼ç­å¼å®¹OpenAIæ¥å£ï¼ä»åå¯æ§è¡æä»¶ï¼éç½®è¶çº§ç®åï¼ä¸é®é¨ç½²ï¼å¼ç®±å³ç¨.  Seamlessly integrate with OpenAI and compatible APIs using a single executable for quick setup and deployment.
 * [WAAS](https://github.com/schibsted/waas) - Whisper as a Service (GUI and API with queuing for OpenAI Whisper)
 * [coai](https://github.com/coaidev/coai) - ð Next Generation AI One-Stop Internationalization Solution. ð ä¸ä¸ä»£ AI ä¸ç«å¼ B/C ç«¯è§£å³æ¹æ¡ï¼æ¯æ OpenAIï¼Midjourneyï¼Claudeï¼è®¯é£æç«ï¼Stable Diffusionï¼DALLÂ·Eï¼ChatGLMï¼éä¹åé®ï¼è¾è®¯æ··åï¼360 æºèï¼ç¾å· AIï¼ç«å±±æ¹èï¼æ°å¿åºï¼Geminiï¼Moonshot ç­æ¨¡åï¼æ¯æå¯¹è¯åäº«ï¼èªå®ä¹é¢è®¾ï¼äºç«¯åæ­¥ï¼æ¨¡åå¸åºï¼æ¯æå¼¹æ§è®¡è´¹åè®¢éè®¡åæ¨¡å¼ï¼æ¯æå¾çè§£æï¼æ¯æèç½æç´¢ï¼æ¯ææ¨¡åç¼å­ï¼ä¸°å¯ç¾è§çåå°ç®¡çä¸ä»ªè¡¨çæ°æ®ç»è®¡ã
 ...
 * [BaseAI](https://github.com/langbaseinc/baseai) - BaseAI â The Web AI Framework. The easiest way to build serverless autonomous AI agents with memory. Start building local-first, agentic pipes, tools, and memory. Deploy serverless with one command.
 ...
 * [APIPark](https://github.com/apiparklab/apipark) - ð¦APIPark is the #1 open-source AI Gateway and Developer Portal, enabling you to easily manage, integrate, and deploy AI and API services. APIPark seamlessly connects with various large AI models and packages these AI capabilities into APIs for easy invocation.
 ...
 * [ShortGPT](https://github.com/rayventura/shortgpt) - ðð¬ ShortGPT - Experimental AI framework for youtube shorts / tiktok channel automation
 * [pr-agent](https://github.com/qodo-ai/pr-agent) - ð PR-Agent (Qodo Merge open-source): An AI-Powered ð¤ Tool for Automated Pull Request Analysis, Feedback, Suggestions and More! ð»ð
 ...
 * [FinRL-Meta](https://github.com/ai4finance-foundation/finrl-meta) - FinRLÂ­-Meta: Dynamic datasets and market environments for FinRL.
 ...
 * [hydra](https://github.com/ory/hydra) - The only web-scale, fully customizable OpenID Certifiedâ¢ OpenID Connect and OAuth2 Provider in the world. Become an OpenID Connect and OAuth2 Provider over night. Written in Go, cloud native, headless, API-first. Available as a service on Ory Network and for self-hosters. Relied upon by OpenAI and others for web-scale security.
 * [Fay](https://github.com/xszyou/fay) - fayæ¯ä¸ä¸ªå¸®å©æ°å­äººï¼2.5dã3dãç§»å¨ãpcãç½é¡µï¼æå¤§è¯­è¨æ¨¡åï¼openaiå¼å®¹ãdeepseekï¼è¿éä¸å¡ç³»ç»çagentæ¡æ¶ã
 ...
 * [AI-Gateway](https://github.com/azure-samples/ai-gateway) - APIM â¤ï¸ AI - This repo contains experiments on Azure API Management's AI capabilities, integrating with Azure OpenAI, AI Foundry, and much more ð
 ...
 * [shippie](https://github.com/mattzcarey/shippie) - an extensible code review agent ð¢
 * [zenfeed](https://github.com/glidea/zenfeed) - Make RSS ð° great again with AI ð§ â¨!!
 ...
 * [course-builder](https://github.com/badass-courses/course-builder) - ð platform for building Badass Courses
 ...
 * [is-even-ai](https://github.com/calvin-ll/is-even-ai) - Check if a number is even with the power of â¨AIâ¨
 * [k8m](https://github.com/weibaohui/k8m) - ä¸æ¬¾è½»éçº§ãè·¨å¹³å°ç Mini Kubernetes AI Dashboardï¼æ¯æå¤§æ¨¡å+æºè½ä½+MCP(æ¯æè®¾ç½®æä½æé)ï¼éæå¤éç¾¤ç®¡çãæºè½åæãå®æ¶å¼å¸¸æ£æµç­åè½ï¼æ¯æå¤æ¶æå¹¶å¯åæä»¶é¨ç½²ï¼å©åé«æéç¾¤ç®¡çä¸è¿ç»´ä¼åã
 ...
 * [gpt-load](https://github.com/tbphp/gpt-load) - ä¸ä¸ªé«æ§è½çOpenAIæ ¼å¼APIå¤å¯é¥è½®è¯¢ä»£çæå¡å¨ï¼æ¯æè´è½½åè¡¡ï¼ä½¿ç¨ Go è¯­è¨å¼åãA high-performance OpenAI-compatible API proxy server with multi-key rotation and load balancing, built with Go.
 ...
 * [pentagi](https://github.com/vxcontrol/pentagi) - â¨ Fully autonomous AI Agents system capable of performing complex penetration testing tasks
 ...
 * [xsai](https://github.com/moeru-ai/xsai) - ð¤ð¬ extra-small AI SDK.
 * [myosuite](https://github.com/myohub/myosuite) - MyoSuite is a collection of environments/tasks to be solved by musculoskeletal models simulated with the MuJoCo physics engine and wrapped in the OpenAI gym API.
 ...
 * [nebullvm](https://github.com/nebuly-ai/nebullvm) - Plug and play modules to optimize the performances of your AI systems ð
 ...
 * [chatgpt_academic](https://github.com/binary-husky/chatgpt_academic) - ç§ç å·¥ä½ä¸ç¨ChatGPTæå±ï¼ç¹å«ä¼åå­¦æ¯Paperæ¶¦è²ä½éªï¼æ¯æèªå®ä¹å¿«æ·æé®ï¼æ¯æmarkdownè¡¨æ ¼æ¾ç¤ºï¼Texå¬å¼åæ¾ç¤ºï¼ä»£ç æ¾ç¤ºåè½å®åï¼æ°å¢æ¬å°Pythonå·¥ç¨åæåè½/èªæåæåè½
 ...
 * [ThreatResearch](https://github.com/securityjoes/threatresearch) - during our latest incident response, @charleslomboni implemented #chatgpt into #ghidra.we've released the code so you could use it too: called it askjoe ð¤ enjoy &amp; share
 ...
 * [Partial-English-Subtitle-Translation](https://github.com/goldengrape/partial-english-subtitle-translation) - åä½åé¨åäºå¿å­¦è±è¯­çäº²ä»¬ï¼æåå¸¦å­¦è±è¯­çå·¥å·æ¥å¦è¿æ¬¡æ¯åªç¿»è¯å­å¹ä¸­ççè¯ï¼èªå·±éé¾åº¦ãæ¬æ¬¡ #æç  çéç¹æ¯ï¼éè¿gptç¿»è¯åºäºåè¯å¨å¥ä¸­çå«ä¹ãç½é¡µçï¼ï¼
 * [GilgaiDetection](https://github.com/geezacoleman/gilgaidetection) - Simple colour thresholdhing for Gilgai detection
 * [chatgpt_stock_report](https://github.com/ddobokki/chatgpt_stock_report) - ê·¸ë ì ì¦ê¶ì¬ ë¦¬í¬í¸ë¥¼ ì± gptë¥¼ íì©í´ ìì½íë ë í¬
 ...
 * [celltypewriter](https://github.com/ntranoslab/celltypewriter) - ðupdate: you can now use #celltypewriter without a #gpt4 api-key. we've set up a #free version so you can try it out on your #data. â¨this will be active for a few days or until funds run out : ) have fun! github link:
 ...
 * [gost-install.ipynb](https://github.com/lewangdev/gost-install.ipynb) - éè¿ Jupyter  Notebook å®è£ GOST
 * [chatgpt-desktop](https://github.com/sonnylazuardi/chatgpt-desktop) - Duel with your facebook friends in flappy bird game play
 * [yobulkdev](https://github.com/yobulkdev/yobulkdev) - ð¥ ð¥ ð¥Open Source & AI driven Data Onboarding Platform:Free flatfile.com alternative
 * [WTF-JavaScript](https://github.com/wtfacademy/wtf-javascript) - ææè¿å¨éæ°å­¦ JavaScript, å·©åºä¸ä¸ç»è, ä¹åä¸ä¸ªâWTF JavaScriptæç®å¥é¨âï¼ä¾æ°äººå­¦ä¹ ã
 ...
 * [ChatGPT-Feishu](https://github.com/bestony/chatgpt-feishu) - ç»é£ä¹¦åå¤ç ChatGPT æºå¨äºº
 ...
 * [appwrite](https://github.com/appwrite/appwrite) - Secure Backend Server for Web, Mobile & Flutter Developers ð AKA the 100% open-source Firebase alternative.
 ...
 * [code-gpt](https://github.com/vaibhavacharya/code-gpt) - Make sense of any code, anytime. ð
 ...
 * [Pake](https://github.com/tw93/pake) - ð¤±ð» Turn any webpage into a desktop app with Rust.  ð¤±ð» å¾ç®åçç¨ Rust æåç½é¡µçæå¾å°çæ¡é¢ App
 ...
 * [wechatgpt](https://github.com/houko/wechatgpt) - wechatgpt golangç chatgptæºå¨äºº(å¯dockeré¨ç½²)ï¼ç®åæ¯æwechatï¼telegram
 ...
 * [haoel.github.io](https://github.com/haoel/haoel.github.io) - åä¸¤å¤©çå°èå­å¥æ´æ°äºä¸ç½çææ¡£  ä¹æ¥è¯´ä¸ä¸ææ¯æä¹è§£å³ chatgptå new bing å°±ç®æäºæ¢¯å­è¿æ¯æ æ³ç»å½æèä½¿ç¨é®é¢çï¼gost + cloudflare warpï¼éç½®èµ·æ¥ä¹æ¯è¾ç®å  (1/n)
 * [FlexGen](https://github.com/ying1123/flexgen) - A game for landscape planing
 * [chatgpt-web](https://github.com/chanzhaoyu/chatgpt-web) - ç¨ Express å  Vue3 æ­å»ºç ChatGPT æ¼ç¤ºç½é¡µ
 ...
 * [MathGPT](https://github.com/meiyulee/mathgpt) - åè²»æ¸å­é©åçæ¸å­¸æ¨¡åäººå·¥æºè½ | çºä½ çæ¸å­å»ºç«æ¸å­¸æ¨¡å |
 ...
 * [ChatGPTForTelegram](https://github.com/kylelin1998/chatgptfortelegram) - ç®åæºå¨äººåºäºChatGPTè¿è¡å¼å  ä½¿ç¨æºå¨äººå¯ä»¥è®©ä½ è½»æ¾è¿è¡å¯¹è¯ï¼ åç»­æºå¨äººçæ´æ°åçº§ä¸ä¸ªå½ä»¤å³å¯æå®ï¼ æ éåä¸æå¡å¨è¿è¡åçº§æºå¨äºº
 ...
 * [Audits-Smart-Contracts](https://github.com/audit-ace/audits-smart-contracts) - ð announcing audit report congratulations chat gpt ð audits dm -
 ...
 * [minlora](https://github.com/cccntu/minlora) - ð exciting news! i just released my new repo, minlora ð this powerful library lets you apply lora to *any* pytorch model in a few lines of code. from @huggingface's transformers, diffusers, to @karpathy's nanogpt. check it out now at
 ...
 * [pandora](https://github.com/pengzhile/pandora) - æ½å¤æï¼ä¸ä¸ªè®©ä½ å¼å¸é¡ºççChatGPTãPandora, a ChatGPT that helps you breathe smoothly.
 ...
 * [gptlink](https://github.com/gptlink/gptlink) - 10åéæ­å»ºèªå·±å¯åè´¹åç¨çChatGPTç¯å¢ï¼æ­å»ºç®åï¼åå«ç¨æ·ï¼è®¢åï¼ä»»å¡ï¼ä»è´¹ç­åè½
 ...
 * [GreatMaster](https://github.com/illumine-labs/greatmaster) - Master, help us to awaken and enlighten. å¤§å¸ï¼ææäºã
 ...
 * [gpt-aggregated-edition](https://github.com/1595901624/gpt-aggregated-edition) - èåChatGPTå®æ¹çãChatGPTåè´¹çãæå¿ä¸è¨ãPoeãchatchatç­å¤å¹³å°ï¼æ¯æèªå®ä¹å¯¼å¥å¹³å°
 * [larc_gpt4](https://github.com/evanthebouncy/larc_gpt4) - larc solving with gpt4
 * [go-proxy-bingai](https://github.com/adams549659584/go-proxy-bingai) - ç¨ Vue3 å Go æ­å»ºçå¾®è½¯ New Bing æ¼ç¤ºç«ç¹ï¼æ¥æä¸è´ç UI ä½éªï¼æ¯æ ChatGPT æç¤ºè¯ï¼å½åå¯ç¨ã
 ...
 * [GPT4Company](https://github.com/easychen/gpt4company) - Gpt4Company is a request forwarder used to prevent Samsung-style leaks. Gpt4Company æ¯ä¸ä¸ªç¨æ¥é¿åä¸æå¼æ³å¯çè¯·æ±è½¬åå¨
 ...
 * [leetcode](https://github.com/azl397985856/leetcode) - æ¨èåè´¹ChatGPTç½ç«ï¼www.lintcode.com/chat-gpt?utm_source=tf-github-lucifer  LeetCode Solutions: A Record of My Problem Solving Journey.( leetcodeé¢è§£ï¼è®°å½èªå·±çleetcodeè§£é¢ä¹è·¯ã)
 * [chatgpt-business](https://github.com/garyvalue/chatgpt-business) - å·²æ±æ»41ä¸ªChatgptåä¸çåæä¾æ´å¤çåç°æ¹å¼,åä¸æºç ç¨åº,è´¦å·APIæ¸ é,æ¯ä»æ¶æ¬¾æ¸ é,æå¡å¨æ¸ é,è¯¾ç¨éå¥æå¡,CHATGPTç¥è¯æç,å¼åå®å¶å¤å
 ...
 * [gpt-react-designer](https://github.com/xd2sketch/gpt-react-designer) - â¡ï¸ Generate and preview âï¸ React components with ð¤ ChatGPT
 ...
 * [AIChatWeb](https://github.com/nanjiren01/aichatweb) - å¨ChatGPT-Next-Webçåºç¡ä¸ï¼å¢å æ³¨åç»å½ï¼é¢åº¦éå¶ï¼éè¯·ï¼ææè¯ï¼æ¯ä»ï¼åºäºdockerä¸é®é¨ç½²ãæä¾åå°ç®¡çç³»ç»ï¼å¯éç½®æ é¢ãæ¬¢è¿è¯ãé¢åº¦ä¸è¶³æéãå¬å
 * [gptAssist](https://github.com/woheller69/gptassist) - gptAssist is a simple WebView wrapper for ChatGPT
 * [personal_chatgpt](https://github.com/chunhuizhang/personal_chatgpt) - personal chatgpt
 ...
 * [azurechatgpt](https://github.com/microsoft/azurechatgpt) - ð¤ Azure ChatGPT: Private & secure ChatGPT for internal enterprise use ð¼
 * [ChatGPT-Nine-Ai](https://github.com/dreamergrow/chatgpt-nine-ai) - ä½¿ç¨ Nestjs å Vue3 æ­å»ºç åä¸åChatGPTç½ç«
 * [gptlink-web](https://github.com/gptlink/gptlink-web) - A ChatGPT web app by React and Tailwind CSSï¼API by gptlinkã
 * [ChatGPT-Virtual-Live](https://github.com/smallnew666/chatgpt-virtual-live) - ChatGPTèæä¸»æ­ãæ¯æBç«ãæé³ãè§é¢å·
 ...
 * [ExcelGPT](https://github.com/asterecho/excelgpt) - chatgpt for Excel ï¼åºäºExcelDNAå¼å
 * [OpenCopilot](https://github.com/newfyu/opencopilot) - ChatGPTçè·¨å¹³å°æ¡é¢å®¢æ·ç«¯ï¼ç®æ´çç¨æ·çé¢åéæ¶å¤èµ·çä½éªãææå»ºæ¬å°ç¥è¯åºãç½ç»æ£ç´¢ãé¿ææ¬éè¯»ãæ§è¡æ¬å°ä»£ç ç­åè½ã
 ...
 * [azurechatgpt](https://github.com/dandinu/azurechatgpt) - ð¤ Azure ChatGPT: Private & secure ChatGPT for internal enterprise use ð¼
 * [OpenGPT-Business](https://github.com/black-fruit/opengpt-business) - chatgptåä¸åºç¨ï¼79E/ChatGpt-Web ç1.3.9ææ°ï¼æ¬äººç ´è§£ï¼æ éææï¼
 ...
 * [ChatPaper2Xmind](https://github.com/masteryip/chatpaper2xmind) - è®ºæXMindç¬è®°çæå·¥å·ï¼å°è®ºæpdféè¿ChatGPTè½¬æ¢ä¸ºå¸¦æå¾çåå¬å¼çç®è¦XMindç¬è®°ï¼æé«è®ºæéè¯»æçã
 ...
 * [NeuroGPT](https://github.com/em1tsan/neurogpt) - ÐÐµÑÐ¿Ð»Ð°ÑÐ½ÑÐ¹ ChatGPT 3.5 / ChatGPT 4
 ...
 * [midjourney_turbo](https://github.com/chazzjimel/midjourney_turbo) - chatgpt-on-wechatçmjç»å¾æä»¶ï¼æ¯ææ¬¡æ°éå¶ï¼GPTå³é®è¯æ¶¦è²ï¼å¾çåæï¼ä»¥å¾çå¾
 * [humanify](https://github.com/jehna/humanify) - Un-minify Javascript code using ChatGPT
 * [careerboost](https://github.com/dmswl98/careerboost) - ð chatGPT ì´ë ¥ì ì²¨ì­ ìë¹ì¤
 * [livecodingthefuture-docker-terraform](https://github.com/digitalinnovationone/livecodingthefuture-docker-terraform) - Projeto Criado para salvar os Exemplos da Live Conding The Future. Realizando deploy de uma aplicaÃ§Ã£o web em cloud com Docker, Terraform, Bard e ChatGPT
 * [chatgpt-jiezi](https://github.com/hncboy/chatgpt-jiezi) - ChatGPT ç®¡çç«¯-è§£å­
 * [GPT-WEB-JAVA](https://github.com/a616567126/gpt-web-java) - åºäºJDK8 AI èå¤©æºå¨äººï¼å¾®ä¿¡å¬ä¼å· Midjourneyç»å¾ãå¡å¯åæ¢ãweb æ¯æChatGPTãMidjourneyç»å¾ãsdç»å¾ï¼å¡å¯åæ¢ï¼ææ¯ä»ï¼å¬ä¼å·å¼æµï¼é®ä»¶æ³¨åð¥
 ...
 * [ChatLog](https://github.com/thu-keg/chatlog) - â³ ChatLog: Recording and Analysing ChatGPT Across Time
 ...
 * [ChatReviewer](https://github.com/nishiwen1214/chatreviewer) - ChatReviewer: ä½¿ç¨ChatGPTåæè®ºæä¼ç¼ºç¹ï¼æåºæ¹è¿å»ºè®®
 * [ChatGLM-Tuning](https://github.com/mymusise/chatglm-tuning) - ä¸ç§å¹³ä»·çchatgptå®ç°æ¹æ¡,  åºäºChatGLM-6B + LoRA
 ...
 * [chatnio](https://github.com/deeptrain-community/chatnio) - ð è½»éçº§ ChatGPT èå¤©å¹³å°, å®ç° ChatGPT èç½åè½ï¼å¤è´¦æ·åè¡¡è´è½½ï¼ç¼å­ï¼é´æç³»ç»ï¼æ¯æ Stream å®æ¶ååºï¼å¾åçæï¼å¯¹è¯è®°å¿åè½ ð Lightweight ChatGPT chat platform, implement ChatGPT online searching service, multi-account load balancing, cache, authentication system, supports stream real-time response, image generation and memory function
 ...
 * [wechat_gpt_laf](https://github.com/husanr/wechat_gpt_laf) - ä½¿ç¨Lafäºå¹³å°ï¼ä¸¤æ­¥å°ChatGPTæ¥å¥å¾®ä¿¡å¬ä¼å·
 ...
 * [ChatGPT-Next-Web-PRO](https://github.com/llboo/chatgpt-next-web-pro) - ChatGPT-Next-Web æ¥å¥ç®¡çåå°ï¼åæ¬ï¼keyç®¡çãç¨æ·é´æãå¬ä¼å·æ³¨å/æ«ç ç»å½ãæ¯ä»ç®¡çãå¡å¯ç®¡çç­
 * [ChatGPT-AutoExpert](https://github.com/spdustin/chatgpt-autoexpert) - ðð§ ð¬ Supercharged Custom Instructions for ChatGPT (non-coding) and ChatGPT Advanced Data Analysis (coding).
 * [muchat-aio](https://github.com/panyanyany/muchat-aio) - å¢éç ChatGPT Web åºç¨ï¼å¤ç¨æ·ï¼åç»å½ãéåå¬å¸ãç»ç»æå°å¢ä½åé¨ä½¿ç¨ãTeam version of ChatGPT web application- multi-user and no log-in required. Suitable for internal use in companies, organizations or small groups.
 ...
 * [SuperCLUE](https://github.com/cluebenchmark/superclue) - SuperCLUE: ä¸­æéç¨å¤§æ¨¡åç»¼åæ§åºå | A Benchmark for Foundation Models in Chinese
 ...
 * [next-enterprise](https://github.com/blazity/next-enterprise) - ð¼ An enterprise-grade Next.js boilerplate for high-performance, maintainable apps. Packed with features like Tailwind CSS, TypeScript, ESLint, Prettier, testing tools, and more to accelerate your development.
 ...
 * [ChatGPT-Next-Web](https://github.com/chatgptnextwebteam/chatgpt-next-web) - A well-designed cross-platform ChatGPT UI (Web / PWA / Linux / Win / MacOS). ä¸é®æ¥æä½ èªå·±çè·¨å¹³å° ChatGPT åºç¨ã
 * [ChatGLM-Finetuning](https://github.com/liucongg/chatglm-finetuning) - åºäºChatGLM-6BãChatGLM2-6BãChatGLM3-6Bæ¨¡åï¼è¿è¡ä¸æ¸¸å·ä½ä»»å¡å¾®è°ï¼æ¶åFreezeãLoraãP-tuningãå¨åå¾®è°ç­
 * [ChatGPT-Next-Web](https://github.com/chatgptnextweb/chatgpt-next-web) - A well-designed cross-platform ChatGPT UI (Web / PWA / Linux / Win / MacOS). ä¸é®æ¥æä½ èªå·±çè·¨å¹³å° ChatGPT åºç¨ã
 ...
 * [modelscope-agent](https://github.com/modelscope/modelscope-agent) - ModelScope-Agent(å¼æºçGPTs): An agent framework connecting models in ModelScope with the world
 ...
 * [gerev](https://github.com/gerevai/gerev) - ð§  AI-powered enterprise search engine ð
 * [Replit-Xray](https://github.com/yonggekkk/replit-xray) - Replitå®¹å¨é¨ç½²xrayä»£çï¼æ¯æèªå®ä¹ä¼ªè£ç½é¡µï¼ä¸é®äºåè®®å±å­ï¼æ¯ææ­å»ºvlessãvmessãtrojanãshadowsocksãsocksï¼æ¯ææ¬å°ä¸ä¼ ä¸replitå¹³å°forkä¸¤ç§æ¨¡å¼é¨ç½²
 ...
 * [smart-ide](https://github.com/airuikun/smart-ide) - å¨vscodeæä»¶ä¸­ç»åchatgptè½åï¼å®ç°æºè½ç åææ
 * [comfyui-mixlab-nodes](https://github.com/shadowcz007/comfyui-mixlab-nodes) - Workflow-to-APPãScreenShare&FloatingVideoãGPT & 3DãSpeechRecognition&TTS
 ...
 * [inke](https://github.com/yesmore/inke) - ð A WYSIWYG notebook with AI assisted writing and real-time collaboration. Support self hosting.  ä¸ä¸ªæè§å³æå¾çMarkdownç¬è®°æ¬ï¼æ¯æAIè¾å©åä½åå¤äººåä½ï¼æ¯æèªé¨ç½²ï¼ä½¿ç¨IndexedDBå­å¨ç¬è®°ã
 ...
 * [GalTransl](https://github.com/cx2333-gt/galtransl) - æ¯æGPT-3.5/GPT-4/Newbing/Sakuraç­å¤§è¯­è¨æ¨¡åçGalgameèªå¨åç¿»è¯è§£å³æ¹æ¡
 ...
 * [wechatSDK](https://github.com/kawika-git/wechatsdk) - å¾®ä¿¡æºå¨äººæ¯ä¸ä¸ªåæ°çåºäºPython 3.11å¼åçé¡¹ç®ï¼éè¿ç»åChatGPTæ¨¡ååå¾®ä¿¡åçAPIï¼ä¸ºç¨æ·æä¾æºè½èå¤©ãèªå¨ç»ç»ãèªå¨åæååãèªå¨åè§é¢å·ç­å¤æ ·çAPIéææå¡ï¼æ¨å¨æåæ¥å¸¸æ²éæçåè¶£å³æ§ã
 * [Bunny](https://github.com/baai-dcai/bunny) - A family of lightweight multimodal models.
 * [ChatGPT-API-Faucet](https://github.com/terobox/chatgpt-api-faucet) - AI åçæ°´é¾å¤´ç½ç«ï¼æ¯24å°æ¶å¯é¢åä¸ä¸ªä»¤çç¨äºå¼åæµè¯ AI äº§å
 ...
 * [wechatSDK](https://github.com/wechatapis/wechatsdk) - å¾®ä¿¡æºå¨äººæ¯ä¸ä¸ªåæ°çåºäºPython 3.11å¼åçé¡¹ç®ï¼éè¿ç»åChatGPTæ¨¡ååå¾®ä¿¡åçAPIï¼ä¸ºç¨æ·æä¾æºè½èå¤©ãèªå¨ç»ç»ãèªå¨åæååãèªå¨åè§é¢å·ç­å¤æ ·çAPIéææå¡ï¼æ¨å¨æåæ¥å¸¸æ²éæçåè¶£å³æ§ã
 ...
 * [GalTransl](https://github.com/xd2333/galtransl) - æ¯æGPT-3.5/GPT-4/Newbing/Sakuraç­å¤§è¯­è¨æ¨¡åçGalgameèªå¨åç¿»è¯è§£å³æ¹æ¡  Automated translation solution for visual novels supporting GPT-3.5/GPT-4/Newbing/Sakura
 * [VAR](https://github.com/foundationvision/var) - [GPT beats diffusionð¥] [scaling laws in visual generationð] Official impl. of "Visual Autoregressive Modeling: Scalable Image Generation via Next-Scale Prediction"
 ...
 * [99AI](https://github.com/vastxie/99ai) - 99AI ç¨³å®çï¼åºäº NineAI äºå¼çå¯åä¸å AI Web åºç¨ï¼åææï¼æ åé¨ï¼æ¯æå¿«éé¨ç½²ï¼ãç®æ  ALL-IN-CHAT
 * [geekai](https://github.com/yangjian102621/geekai) - AI å©æå¨å¥å¼æºè§£å³æ¹æ¡ï¼èªå¸¦è¿è¥ç®¡çåå°ï¼å¼ç®±å³ç¨ãéæäº ChatGPT, Azure, ChatGLM,è®¯é£æç«ï¼æå¿ä¸è¨ç­å¤ä¸ªå¹³å°çå¤§è¯­è¨æ¨¡åãæ¯æ MJ AI ç»ç»ï¼Stable Diffusion AI  ç»ç»ï¼å¾®åç­æç­æä»¶å·¥å·ãéç¨ Go + Vue3 + element-plus å®ç°ã
 * [ChatGPT-on-WeChat](https://github.com/kx-huang/chatgpt-on-wechat) - ð¤ï¸ Deploy ChatGPT on your WeChat within 2 steps! ä¸¤æ­¥å¨äºç«¯é¨ç½²ä½ çå¾®ä¿¡ChatGPTèå¤©æºå¨äººï¼ð¤ï¸
 * [ai-to-pptx](https://github.com/chatbookai/ai-to-pptx) - Ai-to-pptxæ¯ä¸ä¸ªä½¿ç¨AIææ¯(ChatGptåGemini)å¶ä½PPTXçå©æï¼æ¯æå¨çº¿ä¿®æ¹åå¯¼åºPPTXã ä¸»è¦åè½: 1 ä½¿ç¨ChatGPTç­å¤§è¯­è¨æ¨¡åæ¥çæå¤§çº² 2 çæçåå®¹åè®¸ç¨æ·åæ¬¡ä¿®æ¹ 3 çæPPTXçæ¶åå¯ä»¥éæ©ä¸åçæ¨¡æ¿ 4 æ¯æå¨çº¿ä¿®æ¹PPTXçæå­åå®¹ï¼æ ·å¼ï¼å¾çç­ 5 æ¯æå¯¼åºPPTXï¼PDFï¼PNGç­å¤ç§æ ¼å¼
 ...
 * [Protofy](https://github.com/protofy-xyz/protofy) - AI Supercharged LowCode Platform CMS and Framework ðð
 ...
 * [chatgpt](https://github.com/putyy/chatgpt) - uniappãhyperf MineAdmin å®ç°ç chatgptåºç¨ï¼æ¯æå°ç¨åºãh5ãappï¼
 ...
 * [Chatgpt-Makes-Money](https://github.com/xiaoming2028/chatgpt-makes-money) - ChatGPTå¯ä¸èµé±æå·§å¿ç, ChatGPTå¯ä¸èµé±ç§ç±, ChatGPTä»å¥é¨å°ç²¾é
 ...
 * [ChatGPT-airport-tizi-fanqiang](https://github.com/axiba053/chatgpt-airport-tizi-fanqiang) - ChatGPTç§å­¦ä¸ç½æ¢¯å­æºåºæ¨èï¼GPT4åçº§æç¨ï¼Claude-3åè´¹ä½¿ç¨æç¨
 ...
 * [ChatGPT-Mirror](https://github.com/dairoot/chatgpt-mirror) - ð ä¸é®é¨ç½²èªå·±ç ChatGPT éåç«
 ...
 * [minimind](https://github.com/jingyaogong/minimind) - ãå¤§æ¨¡åã3å°æ¶å®å¨ä»0è®­ç»ä¸ä¸ªä»æ26Mçå°åæ°GPTï¼æä½ä»é2Gæ¾å¡å³å¯æ¨çè®­ç»ï¼
 ...
 * [ai-commit](https://github.com/insulineru/ai-commit) - â¨ Make commits easier with ChatGPT, Gitmoji and Conventional Commits ð
 ...
 * [ChatALL](https://github.com/ai-shifu/chatall) - Concurrently chat with ChatGPT, Bing Chat, Bard, Alpaca, Vicuna, Claude, ChatGLM, MOSS, è®¯é£æç«, æå¿ä¸è¨ and more, discover the best answers
 * [shadcn-nextjs-boilerplate](https://github.com/horizon-ui/shadcn-nextjs-boilerplate) - Shadcn UI NextJS Boilerplate â¡ï¸ Free Open-source ChatGPT UI Admin Dashboard Template - Horizon AI Boilerplate
 ...
 * [minimind-v](https://github.com/jingyaogong/minimind-v) - ð ãå¤§æ¨¡åã3å°æ¶ä»0è®­ç»27Måæ°çè§è§å¤æ¨¡æVLMï¼ð Train a 27M-parameter VLM from scratch in just 3 hours!
 ...
 * [agentheroes](https://github.com/agentheroes/agentheroes) - Generate, animate and schedule your AI characters ð¤
 * [chatgpt-tarot-divination](https://github.com/dreamhunter2333/chatgpt-tarot-divination) - AI ç®å½ï¼å åï¼å¡ç½çï¼å§åäºæ ¼ï¼å¨å¬è§£æ¢¦ï¼çè¾°å«å­ï¼æ¢è±ææ°
